...
sudo yum install firefox.x86_64-3.0.1 -y 
sudo yum install xulrunner.x86_64-1.9.0.1 -y 
sudo yum install xulrunner-devel.x86_64-1.9.0.1 -y 
sudo yum install xulrunner-devel-unstable.x86_64-1.9.0.1 -y 
