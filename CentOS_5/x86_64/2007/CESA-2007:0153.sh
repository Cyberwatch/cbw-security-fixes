# CYBERWATCH SAS - 2015
#
# Security fix for CESA-2007:0153
#
# Security announcement date: 2007-04-21 13:47:14 UTC
# Script generation date:     2015-11-09 19:06:36 UTC
#
...
#   - php:5.1.6-11.el5
#   - php-bcmath:5.1.6-11.el5
#   - php-cli:5.1.6-11.el5
#   - php-common:5.1.6-11.el5
#   - php-dba:5.1.6-11.el5
#   - php-devel:5.1.6-11.el5
#   - php-gd:5.1.6-11.el5
#   - php-imap:5.1.6-11.el5
#   - php-ldap:5.1.6-11.el5
#   - php-mbstring:5.1.6-11.el5
#   - php-mysql:5.1.6-11.el5
#   - php-ncurses:5.1.6-11.el5
#   - php-odbc:5.1.6-11.el5
#   - php-pdo:5.1.6-11.el5
#   - php-pgsql:5.1.6-11.el5
#   - php-snmp:5.1.6-11.el5
#   - php-soap:5.1.6-11.el5
#   - php-xml:5.1.6-11.el5
#   - php-xmlrpc:5.1.6-11.el5
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/CESA-2007:0153
#
