...
#
# Security announcement date: 2007-05-10 14:29:39 UTC
...
#   - postgresql-debuginfo:8.1.9-1.el5
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/CESA-2007:0336
#
# Licence: Released under The MIT License (MIT), See LICENSE FILE
sudo yum install postgresql-8.1.23 -y 
sudo yum install postgresql-contrib-8.1.23 -y 
sudo yum install postgresql-debuginfo-8.1.9 -y 
