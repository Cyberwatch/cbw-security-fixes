...
#   - bind-chroot:9.3.4-6.0.2.P1.el5_2.x86_64
#   - bind-devel:9.3.4-6.0.2.P1.el5_2.x86_64
#   - bind-libbind-devel:9.3.4-6.0.2.P1.el5_2.x86_64
#   - bind-libs:9.3.4-6.0.2.P1.el5_2.x86_64
#   - bind-sdb:9.3.4-6.0.2.P1.el5_2.x86_64
#   - bind-utils:9.3.4-6.0.2.P1.el5_2.x86_64
#   - caching-nameserver:9.3.4-6.0.2.P1.el5_2.x86_64
#
