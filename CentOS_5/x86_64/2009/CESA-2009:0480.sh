...
#   - poppler:0.5.4-4.4.el5_3.9.x86_64
#   - poppler-devel:0.5.4-4.4.el5_3.9.x86_64
#   - poppler-utils:0.5.4-4.4.el5_3.9.x86_64
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/CESA-2009:0480
#
