...
#   - xorg-x11-server-sdk:1.1.1-48.76.el5_5.1.x86_64
#   - xorg-x11-server-Xdmx:1.1.1-48.76.el5_5.1.x86_64
#   - xorg-x11-server-Xephyr:1.1.1-48.76.el5_5.1.x86_64
#   - xorg-x11-server-Xnest:1.1.1-48.76.el5_5.1.x86_64
#   - xorg-x11-server-Xorg:1.1.1-48.76.el5_5.1.x86_64
#   - xorg-x11-server-Xvfb:1.1.1-48.76.el5_5.1.x86_64
#   - xorg-x11-server-Xvnc-source:1.1.1-48.76.el5_5.1.x86_64
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/CESA-2010:0382
#
