...
#   - samba3x-doc:3.5.4-0.70.el5_6.1
#   - samba3x-domainjoin-gui:3.5.4-0.70.el5_6.1
#   - samba3x-swat:3.5.4-0.70.el5_6.1
#   - samba3x-winbind:3.5.4-0.70.el5_6.1
#   - samba3x-winbind-devel:3.5.4-0.70.el5_6.1
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/CESA-2011:0306
#
