...
#   - kmod-kvm:83-239.el5.centos.1.x86_64
#   - kmod-kvm-debug:83-239.el5.centos.1.x86_64
#   - kvm:83-239.el5.centos.1.x86_64
#   - kvm-qemu-img:83-239.el5.centos.1.x86_64
#   - kvm-tools:83-239.el5.centos.1.x86_64
#
