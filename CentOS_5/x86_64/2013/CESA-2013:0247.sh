...
# Script generation date:     2016-01-22 07:13:49 UTC
#
# Operating System: CentOS 5
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - java-1.7.0-openjdk:1.7.0.9-2.3.5.3.el5_9.x86_64
#   - java-1.7.0-openjdk-demo:1.7.0.9-2.3.5.3.el5_9.x86_64
#   - java-1.7.0-openjdk-devel:1.7.0.9-2.3.5.3.el5_9.x86_64
#   - java-1.7.0-openjdk-javadoc:1.7.0.9-2.3.5.3.el5_9.x86_64
#   - java-1.7.0-openjdk-src:1.7.0.9-2.3.5.3.el5_9.x86_64
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/CESA-2013:0247
#
