...
#   - xorg-x11-server-sdk:1.1.1-48.101.0.1.el5.centos.2.x86_64
#   - xorg-x11-server-Xdmx:1.1.1-48.101.0.1.el5.centos.2.x86_64
#   - xorg-x11-server-Xephyr:1.1.1-48.101.0.1.el5.centos.2.x86_64
#   - xorg-x11-server-Xnest:1.1.1-48.101.0.1.el5.centos.2.x86_64
#   - xorg-x11-server-Xorg:1.1.1-48.101.0.1.el5.centos.2.x86_64
#   - xorg-x11-server-Xvfb:1.1.1-48.101.0.1.el5.centos.2.x86_64
#   - xorg-x11-server-Xvnc-source:1.1.1-48.101.0.1.el5.centos.2.x86_64
#
...
#   - xorg-x11-server-Xvnc-source:1.1.1-48.107.el5.centos.x86_64
#
# CVE List:
#   - CVE-2013-6424
#
