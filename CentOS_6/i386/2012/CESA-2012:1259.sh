...
#   - quagga.i686:0.99.15-7.el6_3.2
#   - quagga-contrib.i686:0.99.15-7.el6_3.2
...
sudo yum install quagga.i686-0.99.15 -y 
sudo yum install quagga-contrib.i686-0.99.15 -y 
