...
#   - boost-static.i686:1.41.0-15.el6_4
...
sudo yum install boost-graph-openmpi.i686-1.41.0 -y 
sudo yum install boost-iostreams.i686-1.41.0 -y 
sudo yum install boost-math.i686-1.41.0 -y 
...
sudo yum install boost-openmpi.i686-1.41.0 -y 
sudo yum install boost-openmpi-devel.i686-1.41.0 -y 
sudo yum install boost-openmpi-python.i686-1.41.0 -y 
...
sudo yum install boost-static.i686-1.41.0 -y 
