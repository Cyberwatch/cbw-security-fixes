...
#   - libsmbclient-devel:3.5.10-116.el6_2
#   - samba:3.5.10-116.el6_2
#   - samba-client:3.5.10-116.el6_2
#   - samba-common:3.5.10-116.el6_2
#   - samba-doc:3.5.10-116.el6_2
#   - samba-domainjoin-gui:3.5.10-116.el6_2
#   - samba-swat:3.5.10-116.el6_2
#   - samba-winbind:3.5.10-116.el6_2
#   - samba-winbind-clients:3.5.10-116.el6_2
#   - samba-winbind-devel:3.5.10-116.el6_2
#   - samba-winbind-krb5-locator:3.5.10-116.el6_2
#
