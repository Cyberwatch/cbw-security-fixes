...
#   - firefox:10.0.8-1.el6.centos.x86_64
#   - xulrunner:10.0.8-1.el6.centos.x86_64
#   - xulrunner-devel:10.0.8-1.el6.centos.x86_64
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/CESA-2012:1350
#
