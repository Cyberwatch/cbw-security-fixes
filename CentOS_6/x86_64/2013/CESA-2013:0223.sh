...
#   - kernel-doc:2.6.32-279.22.1.el6.noarch
#   - kernel-firmware:2.6.32-279.22.1.el6.noarch
#   - kernel:2.6.32-279.22.1.el6.x86_64
#   - kernel-debug:2.6.32-279.22.1.el6.x86_64
#   - kernel-debug-devel:2.6.32-279.22.1.el6.x86_64
#   - kernel-devel:2.6.32-279.22.1.el6.x86_64
#   - kernel-headers:2.6.32-279.22.1.el6.x86_64
#   - perf:2.6.32-279.22.1.el6.x86_64
#   - python-perf:2.6.32-279.22.1.el6.x86_64
#
