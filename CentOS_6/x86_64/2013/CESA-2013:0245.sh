...
# Script generation date:     2015-11-19 07:05:15 UTC
#
# Operating System: CentOS 6
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - java-1.6.0-openjdk:1.6.0.0-1.54.1.11.6.el6_3
#   - java-1.6.0-openjdk-demo:1.6.0.0-1.54.1.11.6.el6_3
#   - java-1.6.0-openjdk-devel:1.6.0.0-1.54.1.11.6.el6_3
#   - java-1.6.0-openjdk-javadoc:1.6.0.0-1.54.1.11.6.el6_3
#   - java-1.6.0-openjdk-src:1.6.0.0-1.54.1.11.6.el6_3
#
