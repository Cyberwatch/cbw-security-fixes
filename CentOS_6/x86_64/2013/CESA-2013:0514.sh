...
#   - php:5.3.3-22.el6
#   - php-bcmath:5.3.3-22.el6
#   - php-cli:5.3.3-22.el6
#   - php-common:5.3.3-22.el6
#   - php-dba:5.3.3-22.el6
#   - php-devel:5.3.3-22.el6
#   - php-embedded:5.3.3-22.el6
#   - php-enchant:5.3.3-22.el6
#   - php-fpm:5.3.3-22.el6
#   - php-gd:5.3.3-22.el6
#   - php-imap:5.3.3-22.el6
#   - php-intl:5.3.3-22.el6
#   - php-ldap:5.3.3-22.el6
#   - php-mbstring:5.3.3-22.el6
#   - php-mysql:5.3.3-22.el6
#   - php-odbc:5.3.3-22.el6
#   - php-pdo:5.3.3-22.el6
#   - php-pgsql:5.3.3-22.el6
#   - php-process:5.3.3-22.el6
#   - php-pspell:5.3.3-22.el6
#   - php-recode:5.3.3-22.el6
#   - php-snmp:5.3.3-22.el6
#   - php-soap:5.3.3-22.el6
#   - php-tidy:5.3.3-22.el6
#   - php-xml:5.3.3-22.el6
#   - php-xmlrpc:5.3.3-22.el6
#   - php-zts:5.3.3-22.el6
#
