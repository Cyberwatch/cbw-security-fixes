...
# Script generation date:     2015-12-16 07:14:16 UTC
#
# Operating System: CentOS 6
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - kernel-doc:2.6.32-358.0.1.el6
#   - kernel-firmware:2.6.32-358.0.1.el6
#   - kernel:2.6.32-358.0.1.el6
#   - kernel-debug:2.6.32-358.0.1.el6
#   - kernel-debug-devel:2.6.32-358.0.1.el6
#   - kernel-devel:2.6.32-358.0.1.el6
#   - kernel-headers:2.6.32-358.0.1.el6
#   - perf:2.6.32-358.0.1.el6
#   - python-perf:2.6.32-358.0.1.el6
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/CESA-2013:0567
#
