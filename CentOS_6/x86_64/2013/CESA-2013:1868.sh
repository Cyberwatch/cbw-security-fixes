...
#   - xorg-x11-server-source.noarch:1.13.0-23.1.el6.centos
#   - xorg-x11-server-common.x86_64:1.13.0-23.1.el6.centos
#   - xorg-x11-server-devel.x86_64:1.13.0-23.1.el6.centos
#   - xorg-x11-server-Xdmx.x86_64:1.13.0-23.1.el6.centos
#   - xorg-x11-server-Xephyr.x86_64:1.13.0-23.1.el6.centos
#   - xorg-x11-server-Xnest.x86_64:1.13.0-23.1.el6.centos
#   - xorg-x11-server-Xorg.x86_64:1.13.0-23.1.el6.centos
#   - xorg-x11-server-Xvfb.x86_64:1.13.0-23.1.el6.centos
#   - xorg-x11-server-devel.i686:1.13.0-23.1.el6.centos
#
