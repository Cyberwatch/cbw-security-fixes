...
#   - ruby193-rubygem-actionpack:3.2.8-5.3.el6.centos.alt
#   - ruby193-rubygem-actionpack-doc:3.2.8-5.3.el6.centos.alt
#
# Last versions recommanded by security team:
#   - ruby193-rubygem-actionpack:3.2.8-5.5.el6.centos.alt
#   - ruby193-rubygem-actionpack-doc:3.2.8-5.5.el6.centos.alt
#
# CVE List:
#   - CVE-2014-0081
#   - CVE-2014-0082
