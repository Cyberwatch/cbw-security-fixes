...
# CYBERWATCH SAS - 2016
#
# Security fix for CESA-2016:2604
#
# Security announcement date: 2016-11-25 16:02:08 UTC
...
#   - resteasy-base-client.noarch:3.0.6-4.el7
...
#   - resteasy-base-resteasy-pom.noarch:3.0.6-4.el7
...
sudo yum install resteasy-base-client.noarch-3.0.6 -y 
...
sudo yum install resteasy-base-resteasy-pom.noarch-3.0.6 -y 
