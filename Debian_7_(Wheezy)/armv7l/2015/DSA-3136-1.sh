...
sudo apt-get install --only-upgrade libpolarssl-dev=1.2.9-1~deb7u5 -y
sudo apt-get install --only-upgrade libpolarssl-runtime=1.2.9-1~deb7u5 -y
sudo apt-get install --only-upgrade libpolarssl0=1.2.9-1~deb7u5 -y
