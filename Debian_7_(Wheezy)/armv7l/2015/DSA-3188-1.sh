...
sudo apt-get install --only-upgrade libfreetype6=2.4.9-1.1+deb7u2 -y
sudo apt-get install --only-upgrade libfreetype6-dev=2.4.9-1.1+deb7u2 -y
sudo apt-get install --only-upgrade freetype2-demos=2.4.9-1.1+deb7u2 -y
