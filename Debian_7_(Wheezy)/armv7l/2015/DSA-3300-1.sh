...
#   - iceweasel-dbg:31.8.0esr-1~deb7u1
#   - iceweasel-dev:31.8.0esr-1~deb7u1
#
...
sudo apt-get install --only-upgrade iceweasel-dbg=38.3.0esr-1~deb7u1 -y
sudo apt-get install --only-upgrade iceweasel-dev=38.3.0esr-1~deb7u1 -y
