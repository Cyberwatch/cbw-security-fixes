...
# Script generation date:     2016-07-28 21:09:15 UTC
#
...
#   - libgl1-mesa-swx11-i686:8.0.5-4+deb7u2
...
sudo apt-get install --only-upgrade libgl1-mesa-swx11-i686=8.0.5-4+deb7u2 -y
