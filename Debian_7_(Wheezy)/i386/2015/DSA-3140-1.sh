...
# Script generation date:     2016-09-12 11:48:39 UTC
#
...
#   - xen-hypervisor-4.1-i386:4.1.4-3+deb7u4
#   - xen-system-i386:4.1.4-3+deb7u4
#
...
#   - xen-hypervisor-4.1-i386:4.1.6.1-1+deb7u1
#   - xen-system-i386:4.1.6.1-1+deb7u1
#
# CVE List:
#   - CVE-2014-8594
#   - CVE-2014-8595
...
sudo apt-get install --only-upgrade xen-hypervisor-4.1-i386=4.1.6.1-1+deb7u1 -y
sudo apt-get install --only-upgrade xen-system-i386=4.1.6.1-1+deb7u1 -y
