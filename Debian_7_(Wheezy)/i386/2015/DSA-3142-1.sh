...
#   - libc6-amd64:2.13-38+deb7u7
#   - libc6-dev-amd64:2.13-38+deb7u7
#   - libc6-i686:2.13-38+deb7u7
#   - libc6-xen:2.13-38+deb7u7
#
...
#   - libc6-i686:2.13-38+deb7u11
#   - libc6-xen:2.13-38+deb7u11
#
# CVE List:
#   - CVE-2012-6656
#   - CVE-2014-6040
...
sudo apt-get install --only-upgrade libc6-amd64=2.13-38+deb7u11 -y
sudo apt-get install --only-upgrade libc6-dev-amd64=2.13-38+deb7u11 -y
sudo apt-get install --only-upgrade libc6-i686=2.13-38+deb7u11 -y
sudo apt-get install --only-upgrade libc6-xen=2.13-38+deb7u11 -y
