...
#   - lib64expat1-dev:2.1.0-1+deb7u2
#   - lib64expat1:2.1.0-1+deb7u2
#   - libexpat1-dev:2.1.0-1+deb7u2
#   - libexpat1:2.1.0-1+deb7u2
#
# Last versions recommanded by security team:
#   - expat:2.1.0-1+deb7u4
#   - lib64expat1-dev:2.1.0-1+deb7u4
#   - lib64expat1:2.1.0-1+deb7u4
...
sudo apt-get install --only-upgrade lib64expat1-dev=2.1.0-1+deb7u4 -y
sudo apt-get install --only-upgrade lib64expat1=2.1.0-1+deb7u4 -y
