...
# Script generation date:     2016-07-28 21:09:50 UTC
#
...
#   - libc-dev-bin:2.13-38+deb7u4
#   - glibc-doc:2.13-38+deb7u4
#   - eglibc-source:2.13-38+deb7u4
#   - locales:2.13-38+deb7u4
#   - locales-all:2.13-38+deb7u4
#   - nscd:2.13-38+deb7u4
#   - multiarch-support:2.13-38+deb7u4
#   - libc6:2.13-38+deb7u4
#   - libc6-dev:2.13-38+deb7u4
#   - libc6-dbg:2.13-38+deb7u4
#   - libc6-prof:2.13-38+deb7u4
#   - libc6-pic:2.13-38+deb7u4
#   - libc6-i386:2.13-38+deb7u4
#   - libc6-dev-i386:2.13-38+deb7u4
#
