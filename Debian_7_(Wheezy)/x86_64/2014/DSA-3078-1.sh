...
#   - libksba-dev:1.2.0-2+deb7u2
#   - libksba8:1.2.0-2+deb7u2
#
# CVE List:
#   - CVE-2014-9087
#
...
sudo apt-get install --only-upgrade libksba-dev=1.2.0-2+deb7u2 -y
sudo apt-get install --only-upgrade libksba8=1.2.0-2+deb7u2 -y
