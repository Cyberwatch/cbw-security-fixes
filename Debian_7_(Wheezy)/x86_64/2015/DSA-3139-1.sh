...
# Script generation date:     2016-07-25 21:09:22 UTC
#
...
#   - squid-common:2.7.STABLE9-4.1+deb7u2
#
# CVE List:
#   - CVE-2014-3609
#
...
sudo apt-get install --only-upgrade squid-common=2.7.STABLE9-4.1+deb7u2 -y
