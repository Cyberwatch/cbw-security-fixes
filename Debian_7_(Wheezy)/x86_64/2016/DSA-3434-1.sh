...
# Script generation date:     2016-07-28 21:11:01 UTC
#
...
#   - linux-headers-3.2.0-4-all-amd64:3.2.73-2+deb7u2
#
...
#   - linux-headers-3.2.0-4-all-amd64:3.2.81-1
#
# CVE List:
#   - CVE-2015-7513
#   - CVE-2015-7550
...
sudo apt-get install --only-upgrade linux-headers-3.2.0-4-all-amd64=3.2.81-1 -y
