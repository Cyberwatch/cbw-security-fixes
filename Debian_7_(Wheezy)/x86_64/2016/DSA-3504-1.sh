...
#   - bsh:2.0b4-12+deb7u2
#   - bsh-gcj:2.0b4-12+deb7u2
#   - bsh-doc:2.0b4-12+deb7u2
#   - bsh-src:2.0b4-12+deb7u2
#
# CVE List:
#   - CVE-2016-2510
#
...
sudo apt-get install --only-upgrade bsh-gcj=2.0b4-12+deb7u2 -y
sudo apt-get install --only-upgrade bsh-doc=2.0b4-12+deb7u2 -y
sudo apt-get install --only-upgrade bsh-src=2.0b4-12+deb7u2 -y
