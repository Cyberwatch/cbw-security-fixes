...
# Script generation date:     2016-11-07 21:09:01 UTC
#
# Operating System: Debian 8 (Jessie)
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - mysql-5.5:5.5.44-0+deb8u1
#   - libmysqlclient18:5.5.44-0+deb8u1
#   - libmysqld-pic:5.5.44-0+deb8u1
#   - libmysqld-dev:5.5.44-0+deb8u1
#   - libmysqlclient-dev:5.5.44-0+deb8u1
#   - mysql-common:5.5.44-0+deb8u1
#   - mysql-client-5.5:5.5.44-0+deb8u1
#   - mysql-server-core-5.5:5.5.44-0+deb8u1
#   - mysql-server-5.5:5.5.44-0+deb8u1
#   - mysql-server:5.5.44-0+deb8u1
#   - mysql-client:5.5.44-0+deb8u1
#   - mysql-testsuite:5.5.44-0+deb8u1
#   - mysql-testsuite-5.5:5.5.44-0+deb8u1
#   - mysql-source-5.5:5.5.44-0+deb8u1
#
...
sudo apt-get install --only-upgrade mysql-5.5=5.5.44-0+deb8u1 -y
