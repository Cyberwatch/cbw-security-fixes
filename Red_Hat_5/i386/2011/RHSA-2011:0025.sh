...
#   - cpp.i386:4.1.2-50.el5
#   - gcc.i386:4.1.2-50.el5
...
#   - gcc-gfortran.i386:4.1.2-50.el5
#   - gcc-gnat.i386:4.1.2-50.el5
#   - gcc-java.i386:4.1.2-50.el5
#   - gcc-objc.i386:4.1.2-50.el5
#   - libgcj-devel.i386:4.1.2-50.el5
#   - libgcj-src.i386:4.1.2-50.el5
...
sudo yum install cpp.i386-4.1.2 -y 
sudo yum install gcc.i386-4.1.2 -y 
...
sudo yum install gcc-gfortran.i386-4.1.2 -y 
sudo yum install gcc-gnat.i386-4.1.2 -y 
sudo yum install gcc-java.i386-4.1.2 -y 
sudo yum install gcc-objc.i386-4.1.2 -y 
sudo yum install libgcj-devel.i386-4.1.2 -y 
sudo yum install libgcj-src.i386-4.1.2 -y 
