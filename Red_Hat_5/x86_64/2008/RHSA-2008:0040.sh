...
#   - postgresql:8.2.6-1.el5s2.x86_64
#   - postgresql-contrib:8.2.6-1.el5s2.x86_64
#   - postgresql-debuginfo:8.2.6-1.el5s2.x86_64
#   - postgresql-devel:8.2.6-1.el5s2.x86_64
#   - postgresql-docs:8.2.6-1.el5s2.x86_64
#   - postgresql-libs:8.2.6-1.el5s2.x86_64
#   - postgresql-plperl:8.2.6-1.el5s2.x86_64
#   - postgresql-plpython:8.2.6-1.el5s2.x86_64
#   - postgresql-pltcl:8.2.6-1.el5s2.x86_64
#   - postgresql-python:8.2.6-1.el5s2.x86_64
#   - postgresql-server:8.2.6-1.el5s2.x86_64
#   - postgresql-tcl:8.2.6-1.el5s2.x86_64
#   - postgresql-test:8.2.6-1.el5s2.x86_64
#
