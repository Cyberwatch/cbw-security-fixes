...
# Script generation date:     2015-09-10 09:41:40 UTC
#
# Operating System: Red Hat 5
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - sblim-cim-client:1.3.3-31.el5_2.1
#   - sblim-cim-client-javadoc:1-31.el5_2.1
#   - sblim-cim-client-manual:1-31.el5_2.1
#   - sblim-cmpi-base:1.5.5-31.el5_2.1
#   - sblim-cmpi-fsvol:1.4.4-31.el5_2.1
#   - sblim-cmpi-network:1.3.8-31.el5_2.1
#   - sblim-cmpi-nfsv3:1.0.14-31.el5_2.1
#   - sblim-cmpi-nfsv4:1.0.12-31.el5_2.1
#   - sblim-cmpi-params:1.2.6-31.el5_2.1
#   - sblim-cmpi-samba:0.5.2-31.el5_2.1
#   - sblim-cmpi-sysfs:1.1.9-31.el5_2.1
#   - sblim-cmpi-syslog:0.7.11-31.el5_2.1
#   - sblim-debuginfo:1-31.el5_2.1
#   - sblim-gather:2.1.2-31.el5_2.1
#   - sblim-gather-provider:2.1.2-31.el5_2.1
#   - sblim-tools-libra:0.2.3-31.el5_2.1
#   - sblim-wbemcli:1.5.1-31.el5_2.1
#   - sblim-cmpi-base-devel:1.5.5-31.el5_2.1
#   - sblim-cmpi-base-test:1.5.5-31.el5_2.1
#   - sblim-cmpi-devel:1.0.4-31.el5_2.1
#   - sblim-cmpi-dns:0.5.2-31.el5_2.1
#   - sblim-cmpi-dns-devel:1-31.el5_2.1
#   - sblim-cmpi-dns-test:1-31.el5_2.1
#   - sblim-cmpi-fsvol-devel:1.4.4-31.el5_2.1
#   - sblim-cmpi-fsvol-test:1.4.4-31.el5_2.1
#   - sblim-cmpi-network-devel:1.3.8-31.el5_2.1
#   - sblim-cmpi-network-test:1.3.8-31.el5_2.1
#   - sblim-cmpi-nfsv3-test:1.0.14-31.el5_2.1
#   - sblim-cmpi-nfsv4-test:1.0.12-31.el5_2.1
#   - sblim-cmpi-params-test:1.2.6-31.el5_2.1
#   - sblim-cmpi-samba-devel:1-31.el5_2.1
#   - sblim-cmpi-samba-test:1-31.el5_2.1
#   - sblim-cmpi-sysfs-test:1.1.9-31.el5_2.1
#   - sblim-cmpi-syslog-test:0.7.11-31.el5_2.1
#   - sblim-gather-devel:2.1.2-31.el5_2.1
#   - sblim-gather-test:2.1.2-31.el5_2.1
#   - sblim-testsuite:1.2.4-31.el5_2.1
#   - sblim-tools-libra-devel:0.2.3-31.el5_2.1
#
