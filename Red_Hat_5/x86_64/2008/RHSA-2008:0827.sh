...
#   - jboss-seam:1.2.1-1.ep1.6.el5
#   - jboss-seam-docs:1.2.1-1.ep1.6.el5
#   - jbossas:4.2.0-4.GA_CP03.ep1.8.el5.1
#   - jbossts:4.2.3-1.SP5_CP01.1jpp.ep1.1.el5
#   - jbossws-jboss42:1.2.1-0jpp.ep1.4.el5.1
#   - jcommon:1.0.12-1jpp.ep1.3.el5
#   - jfreechart:1.0.9-1jpp.ep1.3.el5.1
#   - jgroups:2.4.2-1.GA_CP01.0jpp.ep1.1.el5
#   - rh-eap-docs:4.2.0-3.GA_CP03.ep1.5.el5
#   - rh-eap-docs-examples:4.2.0-3.GA_CP03.ep1.5.el5
#
