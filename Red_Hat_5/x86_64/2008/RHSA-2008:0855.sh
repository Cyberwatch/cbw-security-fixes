...
#   - openssh:3.9p1-10.RHEL4.20
#   - openssh-askpass:3.9p1-10.RHEL4.20
#   - openssh-askpass-gnome:3.9p1-10.RHEL4.20
#   - openssh-clients:3.9p1-10.RHEL4.20
#   - openssh-debuginfo:3.9p1-10.RHEL4.20
#   - openssh-server:3.9p1-10.RHEL4.20
#   - openssh:4.3p2-26.el5_2.1
#   - openssh-askpass:4.3p2-26.el5_2.1
#   - openssh-clients:4.3p2-26.el5_2.1
#   - openssh-debuginfo:4.3p2-26.el5_2.1
...
sudo yum install openssh-askpass-gnome-3.9p1 -y 
