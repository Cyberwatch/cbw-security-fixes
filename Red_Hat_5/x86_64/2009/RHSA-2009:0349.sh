...
#   - glassfish-jaxb:2.1.4-1.6.1.ep1.el5.noarch
#   - glassfish-jaxb-javadoc:2.1.4-1.6.1.ep1.el5.noarch
...
#   - jboss-messaging:1.4.0-2.SP3_CP07.1.ep1.el5.noarch
#   - jboss-remoting:2.2.2-3.SP11.0jpp.ep1.1.el5.noarch
#   - jboss-seam:1.2.1-3.JBPAPP_4_3_0_GA.ep1.10.el5.1.noarch
#   - jboss-seam-docs:1.2.1-3.JBPAPP_4_3_0_GA.ep1.10.el5.1.noarch
#   - jboss-vfs:1.0.0-1.ep1.el5.noarch
#   - jbossas:4.3.0-3.GA_CP04.2.1.ep1.el5.noarch
#   - jbossas-4.3.0.GA_CP04-bin:4.3.0-3.GA_CP04.2.1.ep1.el5.noarch
#   - jbossas-client:4.3.0-3.GA_CP04.2.1.ep1.el5.noarch
#   - jbossts:4.2.3-1.SP5_CP04.1jpp.ep1.2.el5.noarch
#   - jbossweb:2.0.0-6.CP09.0jpp.ep1.1.el5.noarch
#   - jbossws:2.0.1-3.SP2_CP05.3.1.ep1.el5.noarch
#   - jbossws-common:1.0.0-2.GA_CP03.1.ep1.el5.noarch
#   - jbossws-framework:2.0.1-1.GA_CP03.2.ep1.el5.noarch
#   - jgroups:2.4.5-2.1.ep1.el5.noarch
#   - rh-eap-docs:4.3.0-4.GA_CP04.ep1.3.1.el5.noarch
#   - rh-eap-docs-examples:4.3.0-4.GA_CP04.ep1.3.1.el5.noarch
