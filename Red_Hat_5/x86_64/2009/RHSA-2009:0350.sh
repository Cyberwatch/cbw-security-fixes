...
#   - php:5.2.6-4.el5s2
#   - php-bcmath:5.2.6-4.el5s2
#   - php-cli:5.2.6-4.el5s2
#   - php-common:5.2.6-4.el5s2
#   - php-dba:5.2.6-4.el5s2
#   - php-debuginfo:5.2.6-4.el5s2
#   - php-devel:5.2.6-4.el5s2
#   - php-gd:5.2.6-4.el5s2
#   - php-imap:5.2.6-4.el5s2
#   - php-ldap:5.2.6-4.el5s2
#   - php-mbstring:5.2.6-4.el5s2
#   - php-mysql:5.2.6-4.el5s2
#   - php-ncurses:5.2.6-4.el5s2
#   - php-odbc:5.2.6-4.el5s2
#   - php-pdo:5.2.6-4.el5s2
#   - php-pgsql:5.2.6-4.el5s2
#   - php-snmp:5.2.6-4.el5s2
#   - php-soap:5.2.6-4.el5s2
#   - php-xml:5.2.6-4.el5s2
#   - php-xmlrpc:5.2.6-4.el5s2
#
