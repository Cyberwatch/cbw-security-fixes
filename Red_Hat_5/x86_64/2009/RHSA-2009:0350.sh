# CYBERWATCH SAS - 2016
#
# Security fix for RHSA-2009:0350
#
# Security announcement date: 2009-04-14 18:04:50 UTC
...
#   - php:5.2.6-4.el5s2.x86_64
#   - php-bcmath:5.2.6-4.el5s2.x86_64
#   - php-cli:5.2.6-4.el5s2.x86_64
#   - php-common:5.2.6-4.el5s2.x86_64
#   - php-dba:5.2.6-4.el5s2.x86_64
#   - php-debuginfo:5.2.6-4.el5s2.x86_64
#   - php-devel:5.2.6-4.el5s2.x86_64
#   - php-gd:5.2.6-4.el5s2.x86_64
#   - php-imap:5.2.6-4.el5s2.x86_64
#   - php-ldap:5.2.6-4.el5s2.x86_64
#   - php-mbstring:5.2.6-4.el5s2.x86_64
#   - php-mysql:5.2.6-4.el5s2.x86_64
#   - php-ncurses:5.2.6-4.el5s2.x86_64
#   - php-odbc:5.2.6-4.el5s2.x86_64
#   - php-pdo:5.2.6-4.el5s2.x86_64
#   - php-pgsql:5.2.6-4.el5s2.x86_64
#   - php-snmp:5.2.6-4.el5s2.x86_64
#   - php-soap:5.2.6-4.el5s2.x86_64
#   - php-xml:5.2.6-4.el5s2.x86_64
#   - php-xmlrpc:5.2.6-4.el5s2.x86_64
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2009:0350
#
