...
#   - jboss-seam:1.2.1-1.ep1.13.el5.noarch
#   - jboss-seam-docs:1.2.1-1.ep1.13.el5.noarch
#   - jbossas:4.2.0-4.GA_CP07.5.1.ep1.el5.noarch
#   - jbossas-4.2.0.GA_CP07-bin:4.2.0-4.GA_CP07.5.1.ep1.el5.noarch
#   - jbossas-client:4.2.0-4.GA_CP07.5.1.ep1.el5.noarch
#   - jbossts:4.2.3-1.SP5_CP05.1jpp.ep1.1.el5.noarch
#   - jbossweb:2.0.0-6.CP11.0jpp.ep1.1.el5.noarch
#   - jgroups:2.4.6-1.ep1.el5.noarch
#   - rh-eap-docs:4.2.0-5.GA_CP07.ep1.1.1.el5.noarch
#   - rh-eap-docs-examples:4.2.0-5.GA_CP07.ep1.1.1.el5.noarch
#
