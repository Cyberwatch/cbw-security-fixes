...
# Script generation date:     2015-11-04 19:11:14 UTC
#
...
#   - nspr-debuginfo:4.7.4-1.el5_3.1
#   - nss:3.12.3.99.3-1.el5_3.2
#   - nss-debuginfo:3.12.3.99.3-1.el5_3.2
#   - nss-tools:3.12.3.99.3-1.el5_3.2
#   - nspr-devel:4.7.4-1.el5_3.1
#   - nss-devel:3.12.3.99.3-1.el5_3.2
#   - nss-pkcs11-devel:3.12.3.99.3-1.el5_3.2
#
