...
#   - apr-debuginfo:1.2.7-11.el5_3.1
#   - apr-docs:1.2.7-11.el5_3.1
#   - apr-util:1.2.7-7.el5_3.2
#   - apr-util-debuginfo:1.2.7-7.el5_3.2
...
#   - apr-debuginfo:1.2.7-11.el5_6.5
#   - apr-docs:1.2.7-11.el5_6.5
#   - apr-util:1.2.7-11.el5_5.2
#   - apr-util-debuginfo:1.2.7-11.el5_5.2
#   - apr-util-docs:1.2.7-11.el5_5.2
