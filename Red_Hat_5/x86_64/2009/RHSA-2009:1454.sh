...
#   - tomcat5-admin-webapps:5.5.23-0jpp.9.6.ep5.el5
#   - tomcat5-common-lib:5.5.23-0jpp.9.6.ep5.el5
#   - tomcat5-jasper:5.5.23-0jpp.9.6.ep5.el5
#   - tomcat5-jasper-javadoc:5.5.23-0jpp.9.6.ep5.el5
#   - tomcat5-jsp-2.0-api:5.5.23-0jpp.9.6.ep5.el5
#   - tomcat5-jsp-2.0-api-javadoc:5.5.23-0jpp.9.6.ep5.el5
#   - tomcat5-server-lib:5.5.23-0jpp.9.6.ep5.el5
#   - tomcat5-servlet-2.4-api:5.5.23-0jpp.9.6.ep5.el5
#   - tomcat5-servlet-2.4-api-javadoc:5.5.23-0jpp.9.6.ep5.el5
#   - tomcat5-webapps:5.5.23-0jpp.9.6.ep5.el5
#
