...
#   - tomcat6.noarch:6.0.18-12.0.ep5.el5
#   - tomcat6-admin-webapps.noarch:6.0.18-12.0.ep5.el5
#   - tomcat6-docs-webapp.noarch:6.0.18-12.0.ep5.el5
#   - tomcat6-el-1.0-api.noarch:6.0.18-12.0.ep5.el5
#   - tomcat6-javadoc.noarch:6.0.18-12.0.ep5.el5
#   - tomcat6-jsp-2.1-api.noarch:6.0.18-12.0.ep5.el5
#   - tomcat6-lib.noarch:6.0.18-12.0.ep5.el5
#   - tomcat6-log4j.noarch:6.0.18-12.0.ep5.el5
#   - tomcat6-servlet-2.5-api.noarch:6.0.18-12.0.ep5.el5
#   - tomcat6-webapps.noarch:6.0.18-12.0.ep5.el5
#
