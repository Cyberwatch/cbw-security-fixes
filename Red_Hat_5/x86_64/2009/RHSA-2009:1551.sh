...
#   - java-1.4.2-ibm:1.4.2.13.2.sap-1jpp.4.el5_3
#   - java-1.4.2-ibm-demo:1.4.2.13.2.sap-1jpp.4.el5_3
#   - java-1.4.2-ibm-devel:1.4.2.13.2.sap-1jpp.4.el5_3
#   - java-1.4.2-ibm-javacomm:1.4.2.13.2.sap-1jpp.4.el5_3
#   - java-1.4.2-ibm-src:1.4.2.13.2.sap-1jpp.4.el5_3
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2009:1551
#
