...
# Script generation date:     2016-01-11 19:11:49 UTC
#
# Operating System: Red Hat 5
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - glassfish-jaxb:2.1.4-1.12.patch03.1.ep1.el5.noarch
#   - glassfish-jaxb-javadoc:2.1.4-1.12.patch03.1.ep1.el5.noarch
#   - glassfish-jsf:1.2_13-2.1.ep1.el5.noarch
#   - hibernate3:3.2.4-1.SP1_CP09.0jpp.ep1.2.4.el5.noarch
#   - hibernate3-annotations:3.3.1-1.11GA_CP02.ep1.el5.noarch
#   - hibernate3-annotations-javadoc:3.3.1-1.11GA_CP02.ep1.el5.noarch
#   - hibernate3-entitymanager:3.3.2-2.5.1.ep1.el5.noarch
#   - hibernate3-entitymanager-javadoc:3.3.2-2.5.1.ep1.el5.noarch
#   - hibernate3-javadoc:3.2.4-1.SP1_CP09.0jpp.ep1.2.4.el5.noarch
#   - jacorb:2.3.0-1jpp.ep1.9.1.el5.noarch
#   - jboss-aop:1.5.5-3.CP04.2.ep1.el5.noarch
#   - jboss-common:1.2.1-0jpp.ep1.3.el5.1.noarch
#   - jboss-messaging:1.4.0-3.SP3_CP09.4.ep1.el5.noarch
#   - jboss-remoting:2.2.3-3.SP1.ep1.el5.noarch
#   - jboss-seam:1.2.1-3.JBPAPP_4_3_0_GA.ep1.12.el5.1.noarch
#   - jboss-seam-docs:1.2.1-3.JBPAPP_4_3_0_GA.ep1.12.el5.1.noarch
#   - jboss-seam2:2.0.2.FP-1.ep1.18.el5.noarch
#   - jboss-seam2-docs:2.0.2.FP-1.ep1.18.el5.noarch
#   - jbossas:4.3.0-6.GA_CP07.4.2.ep1.el5.noarch
#   - jbossas-4.3.0.GA_CP07-bin:4.3.0-6.GA_CP07.4.2.ep1.el5.noarch
#   - jbossas-client:4.3.0-6.GA_CP07.4.2.ep1.el5.noarch
#   - jbossts:4.2.3-1.SP5_CP08.1jpp.ep1.1.el5.noarch
#   - jbossweb:2.0.0-6.CP12.0jpp.ep1.2.el5.noarch
#   - jbossws:2.0.1-4.SP2_CP07.2.1.ep1.el5.noarch
#   - jbossws-common:1.0.0-2.GA_CP05.1.ep1.el5.noarch
#   - jbossws-framework:2.0.1-1.GA_CP05.1.ep1.el5.noarch
#   - jbossws-native42:2.0.1-4.SP2_CP07.2.1.ep1.el5.noarch
#   - jcommon:1.0.16-1.1.ep1.el5.noarch
#   - jfreechart:1.0.13-2.3.1.ep1.el5.noarch
#   - jgroups:2.4.7-1.ep1.el5.noarch
#   - quartz:1.5.2-1jpp.patch01.ep1.4.1.el5.noarch
#   - rh-eap-docs:4.3.0-6.GA_CP07.ep1.3.el5.noarch
#   - rh-eap-docs-examples:4.3.0-6.GA_CP07.ep1.3.el5.noarch
#   - xml-security:1.3.0-1.3.patch01.ep1.2.1.el5.noarch
#
...
#   - quartz:1.5.2-1jpp.patch01.ep1.4.2.el5.noarch
