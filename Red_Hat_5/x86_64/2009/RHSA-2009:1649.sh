...
#   - glassfish-jaxb.noarch:2.1.4-1.12.patch03.1.ep1.el5
...
#   - jboss-messaging.noarch:1.4.0-3.SP3_CP09.4.ep1.el5
#   - jboss-remoting.noarch:2.2.3-3.SP1.ep1.el5
#   - jboss-seam.noarch:1.2.1-3.JBPAPP_4_3_0_GA.ep1.12.el5.1
#   - jboss-seam-docs.noarch:1.2.1-3.JBPAPP_4_3_0_GA.ep1.12.el5.1
#   - jboss-seam2.noarch:2.0.2.FP-1.ep1.18.el5
#   - jboss-seam2-docs.noarch:2.0.2.FP-1.ep1.18.el5
#   - jbossas.noarch:4.3.0-6.GA_CP07.4.2.ep1.el5
#   - jbossas-4.3.0.GA_CP07-bin.noarch:4.3.0-6.GA_CP07.4.2.ep1.el5
#   - jbossas-client.noarch:4.3.0-6.GA_CP07.4.2.ep1.el5
#   - jbossts.noarch:4.2.3-1.SP5_CP08.1jpp.ep1.1.el5
#   - jbossweb.noarch:2.0.0-6.CP12.0jpp.ep1.2.el5
#   - jbossws.noarch:2.0.1-4.SP2_CP07.2.1.ep1.el5
#   - jbossws-common.noarch:1.0.0-2.GA_CP05.1.ep1.el5
#   - jbossws-framework.noarch:2.0.1-1.GA_CP05.1.ep1.el5
...
#   - rh-eap-docs.noarch:4.3.0-6.GA_CP07.ep1.3.el5
#   - rh-eap-docs-examples.noarch:4.3.0-6.GA_CP07.ep1.3.el5
...
sudo yum install jbossas-4.3.0.GA_CP07-bin.noarch-4.3.0 -y 
