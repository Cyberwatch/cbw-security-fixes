...
# Script generation date:     2015-09-10 09:42:20 UTC
#
# Operating System: Red Hat 5
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - kernel-doc:2.6.18-128.12.1.el5
#   - kernel:2.6.18-128.12.1.el5
#   - kernel-debug:2.6.18-128.12.1.el5
#   - kernel-debug-debuginfo:2.6.18-128.12.1.el5
#   - kernel-debug-devel:2.6.18-128.12.1.el5
#   - kernel-debuginfo:2.6.18-128.12.1.el5
#   - kernel-debuginfo-common:2.6.18-128.12.1.el5
#   - kernel-devel:2.6.18-128.12.1.el5
#   - kernel-headers:2.6.18-128.12.1.el5
#   - kernel-xen:2.6.18-128.12.1.el5
#   - kernel-xen-debuginfo:2.6.18-128.12.1.el5
#   - kernel-xen-devel:2.6.18-128.12.1.el5
#
