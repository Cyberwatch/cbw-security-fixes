...
sudo yum install tomcat5.noarch-5.5.28 -y 
sudo yum install tomcat5-admin-webapps.noarch-5.5.28 -y 
sudo yum install tomcat5-common-lib.noarch-5.5.28 -y 
sudo yum install tomcat5-jasper.noarch-5.5.28 -y 
sudo yum install tomcat5-jasper-eclipse.noarch-5.5.28 -y 
sudo yum install tomcat5-jasper-javadoc.noarch-5.5.28 -y 
sudo yum install tomcat5-jsp-2.0-api.noarch-5.5.28 -y 
sudo yum install tomcat5-jsp-2.0-api-javadoc.noarch-5.5.28 -y 
sudo yum install tomcat5-parent.noarch-5.5.28 -y 
sudo yum install tomcat5-server-lib.noarch-5.5.28 -y 
sudo yum install tomcat5-servlet-2.4-api.noarch-5.5.28 -y 
sudo yum install tomcat5-servlet-2.4-api-javadoc.noarch-5.5.28 -y 
sudo yum install tomcat5-webapps.noarch-5.5.28 -y 
...
sudo yum install tomcat6-el-1.0-api.noarch-6.0.24 -y 
...
sudo yum install tomcat6-log4j.noarch-6.0.24 -y 
