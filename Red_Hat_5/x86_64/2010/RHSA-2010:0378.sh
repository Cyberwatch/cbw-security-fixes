...
#   - jboss-seam:1.2.1-1.ep1.24.el5.noarch
#   - jboss-seam-docs:1.2.1-1.ep1.24.el5.noarch
#   - jbossas:4.2.0-6.GA_CP09.6.ep1.el5.noarch
#   - jbossas-4.2.0.GA_CP09-bin:4.2.0-6.GA_CP09.6.ep1.el5.noarch
#   - jbossas-client:4.2.0-6.GA_CP09.6.ep1.el5.noarch
#   - jbossts:4.2.3-1.SP5_CP09.1jpp.ep1.1.1.el5.noarch
#   - jbossweb:2.0.0-6.CP13.0jpp.ep1.1.1.el5.noarch
#   - rh-eap-docs:4.2.0-7.GA_CP09.ep1.4.1.el5.noarch
#   - rh-eap-docs-examples:4.2.0-7.GA_CP09.ep1.4.1.el5.noarch
#
