...
# Script generation date:     2016-11-07 21:17:32 UTC
#
# Operating System: Red Hat 5
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - java-1.6.0-ibm.x86_64:1.6.0.8-1jpp.1.el5
#   - java-1.6.0-ibm-accessibility.x86_64:1.6.0.8-1jpp.1.el5
#   - java-1.6.0-ibm-demo.x86_64:1.6.0.8-1jpp.1.el5
#   - java-1.6.0-ibm-devel.x86_64:1.6.0.8-1jpp.1.el5
#   - java-1.6.0-ibm-javacomm.x86_64:1.6.0.8-1jpp.1.el5
#   - java-1.6.0-ibm-jdbc.x86_64:1.6.0.8-1jpp.1.el5
#   - java-1.6.0-ibm-plugin.x86_64:1.6.0.8-1jpp.1.el5
#   - java-1.6.0-ibm-src.x86_64:1.6.0.8-1jpp.1.el5
#   - java-1.6.0-ibm.i386:1.6.0.8-1jpp.1.el5
#   - java-1.6.0-ibm-demo.i386:1.6.0.8-1jpp.1.el5
#   - java-1.6.0-ibm-devel.i386:1.6.0.8-1jpp.1.el5
#   - java-1.6.0-ibm-javacomm.i386:1.6.0.8-1jpp.1.el5
#   - java-1.6.0-ibm-jdbc.i386:1.6.0.8-1jpp.1.el5
#   - java-1.6.0-ibm-plugin.i386:1.6.0.8-1jpp.1.el5
#   - java-1.6.0-ibm-src.i386:1.6.0.8-1jpp.1.el5
#
