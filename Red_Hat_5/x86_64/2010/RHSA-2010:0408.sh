...
#   - java-1.4.2-ibm-demo:1.4.2.13.4.sap-1jpp.1.el5
#   - java-1.4.2-ibm-devel:1.4.2.13.4.sap-1jpp.1.el5
#   - java-1.4.2-ibm-javacomm:1.4.2.13.4.sap-1jpp.1.el5
#   - java-1.4.2-ibm-src:1.4.2.13.4.sap-1jpp.1.el5
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2010:0408
#
