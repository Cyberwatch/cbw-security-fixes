...
# Script generation date:     2016-01-11 19:12:01 UTC
#
# Operating System: Red Hat 5
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - java-1.6.0-ibm:1.6.0.8.1-1jpp.2.el5.x86_64
#   - java-1.6.0-ibm-accessibility:1.6.0.8.1-1jpp.2.el5.x86_64
#   - java-1.6.0-ibm-demo:1.6.0.8.1-1jpp.2.el5.x86_64
#   - java-1.6.0-ibm-devel:1.6.0.8.1-1jpp.2.el5.x86_64
#   - java-1.6.0-ibm-javacomm:1.6.0.8.1-1jpp.2.el5.x86_64
#   - java-1.6.0-ibm-jdbc:1.6.0.8.1-1jpp.2.el5.x86_64
#   - java-1.6.0-ibm-plugin:1.6.0.8.1-1jpp.2.el5.x86_64
#   - java-1.6.0-ibm-src:1.6.0.8.1-1jpp.2.el5.x86_64
#
