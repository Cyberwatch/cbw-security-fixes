...
# Script generation date:     2016-01-11 19:12:15 UTC
#
# Operating System: Red Hat 5
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - glassfish-jaxb:2.1.4-1.17.patch04.ep1.el5.noarch
#   - glassfish-jaxws:2.1.1-1jpp.ep1.13.el5.noarch
#   - hibernate3:3.2.4-1.SP1_CP11.0jpp.ep2.0.el5.noarch
#   - hibernate3-annotations:3.3.1-2.0.GA_CP04.ep1.el5.noarch
#   - hibernate3-annotations-javadoc:3.3.1-2.0.GA_CP04.ep1.el5.noarch
#   - hibernate3-javadoc:3.2.4-1.SP1_CP11.0jpp.ep2.0.el5.noarch
#   - javassist:3.9.0-2.ep1.1.el5.noarch
#   - jboss-common:1.2.2-1.ep1.1.el5.noarch
#   - jboss-messaging:1.4.0-4.SP3_CP11.1.ep1.el5.noarch
#   - jboss-remoting:2.2.3-4.SP3.ep1.el5.noarch
#   - jboss-seam:1.2.1-3.JBPAPP_4_3_0_GA.ep1.22.el5.1.noarch
#   - jboss-seam-docs:1.2.1-3.JBPAPP_4_3_0_GA.ep1.22.el5.1.noarch
#   - jboss-seam2:2.0.2.FP-1.ep1.26.el5.noarch
#   - jboss-seam2-docs:2.0.2.FP-1.ep1.26.el5.noarch
#   - jbossas:4.3.0-8.GA_CP09.2.1.ep1.el5.noarch
#   - jbossas-4.3.0.GA_CP09-bin:4.3.0-8.GA_CP09.2.1.ep1.el5.noarch
#   - jbossas-client:4.3.0-8.GA_CP09.2.1.ep1.el5.noarch
#   - jbossts:4.2.3-2.SP5_CP10.1jpp.ep1.1.el5.noarch
#   - jbossweb:2.0.0-7.CP15.0jpp.ep1.1.el5.noarch
#   - jbossws:2.0.1-6.SP2_CP09.2.ep1.el5.noarch
#   - jbossws-common:1.0.0-3.GA_CP06.1.ep1.el5.noarch
#   - jgroups:2.4.9-1.ep1.el5.noarch
#   - quartz:1.5.2-1jpp.patch01.ep1.4.2.el5.noarch
#   - rh-eap-docs:4.3.0-8.GA_CP09.ep1.3.el5.noarch
#   - rh-eap-docs-examples:4.3.0-8.GA_CP09.ep1.3.el5.noarch
#   - xalan-j2:2.7.1-4.ep1.1.el5.noarch
#
