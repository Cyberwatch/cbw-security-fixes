...
# Script generation date:     2016-01-21 19:08:43 UTC
#
# Operating System: Red Hat 5
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - java-1.6.0-sun:1.6.0.26-1jpp.1.el5.x86_64
#   - java-1.6.0-sun-demo:1.6.0.26-1jpp.1.el5.x86_64
#   - java-1.6.0-sun-devel:1.6.0.26-1jpp.1.el5.x86_64
#   - java-1.6.0-sun-jdbc:1.6.0.26-1jpp.1.el5.x86_64
#   - java-1.6.0-sun-plugin:1.6.0.26-1jpp.1.el5.x86_64
#   - java-1.6.0-sun-src:1.6.0.26-1jpp.1.el5.x86_64
#
