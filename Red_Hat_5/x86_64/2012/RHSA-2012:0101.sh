# CYBERWATCH SAS - 2016
#
# Security fix for RHSA-2012:0101
#
# Security announcement date: 2012-02-06 18:41:22 UTC
# Script generation date:     2016-01-11 19:13:07 UTC
#
...
#   - spacewalk-backend-app:1.2.13-66.el5sat.noarch
#   - spacewalk-backend-applet:1.2.13-66.el5sat.noarch
#   - spacewalk-backend-config-files:1.2.13-66.el5sat.noarch
#   - spacewalk-backend-config-files-common:1.2.13-66.el5sat.noarch
#   - spacewalk-backend-config-files-tool:1.2.13-66.el5sat.noarch
#   - spacewalk-backend-iss:1.2.13-66.el5sat.noarch
#   - spacewalk-backend-iss-export:1.2.13-66.el5sat.noarch
#   - spacewalk-backend-libs:1.2.13-66.el5sat.noarch
#   - spacewalk-backend-package-push-server:1.2.13-66.el5sat.noarch
#   - spacewalk-backend-server:1.2.13-66.el5sat.noarch
#   - spacewalk-backend-sql:1.2.13-66.el5sat.noarch
#   - spacewalk-backend-sql-oracle:1.2.13-66.el5sat.noarch
#   - spacewalk-backend-tools:1.2.13-66.el5sat.noarch
#   - spacewalk-backend-upload-server:1.2.13-66.el5sat.noarch
#   - spacewalk-backend-xml-export-libs:1.2.13-66.el5sat.noarch
#   - spacewalk-backend-xmlrpc:1.2.13-66.el5sat.noarch
#   - spacewalk-backend-xp:1.2.13-66.el5sat.noarch
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2012:0101
#
