...
# Script generation date:     2016-11-24 21:15:16 UTC
#
...
#   - hornetq.noarch:2.2.24-1.EAP.GA.ep5.el5
...
#   - hornetq-native.x86_64:2.2.20-1.EAP.GA.1.ep5.el5
#   - hornetq-native-debuginfo.x86_64:2.2.20-1.EAP.GA.1.ep5.el5
...
sudo yum install hornetq.noarch-2.2.24 -y 
...
sudo yum install netty.noarch-3.2.5 -y 
