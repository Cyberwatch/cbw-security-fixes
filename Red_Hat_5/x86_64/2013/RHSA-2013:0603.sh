...
# Script generation date:     2015-10-22 06:11:23 UTC
#
# Operating System: Red Hat 5
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - java-1.7.0-openjdk:1.7.0.9-2.3.8.0.el5_9
#   - java-1.7.0-openjdk-debuginfo:1.7.0.9-2.3.8.0.el5_9
#   - java-1.7.0-openjdk-demo:1.7.0.9-2.3.8.0.el5_9
#   - java-1.7.0-openjdk-devel:1.7.0.9-2.3.8.0.el5_9
#   - java-1.7.0-openjdk-javadoc:1.7.0.9-2.3.8.0.el5_9
#   - java-1.7.0-openjdk-src:1.7.0.9-2.3.8.0.el5_9
#
