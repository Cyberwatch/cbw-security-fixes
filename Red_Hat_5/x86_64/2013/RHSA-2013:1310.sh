# CYBERWATCH SAS - 2015
#
# Security fix for RHSA-2013:1310
#
# Security announcement date: 2013-09-30 23:36:12 UTC
...
#   - samba3x-client:3.6.6-0.136.el5
#   - samba3x-common:3.6.6-0.136.el5
#   - samba3x-debuginfo:3.6.6-0.136.el5
#   - samba3x-doc:3.6.6-0.136.el5
#   - samba3x-domainjoin-gui:3.6.6-0.136.el5
#   - samba3x-swat:3.6.6-0.136.el5
#   - samba3x-winbind:3.6.6-0.136.el5
#   - samba3x-winbind-devel:3.6.6-0.136.el5
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2013:1310
#
