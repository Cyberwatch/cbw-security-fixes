...
# Script generation date:     2016-01-19 19:18:29 UTC
#
...
#   - kernel-debug-debuginfo:2.6.18-371.6.1.el5.x86_64
#   - kernel-debug-devel:2.6.18-371.6.1.el5.x86_64
#   - kernel-debuginfo:2.6.18-371.6.1.el5.x86_64
#   - kernel-debuginfo-common:2.6.18-371.6.1.el5.x86_64
#   - kernel-devel:2.6.18-371.6.1.el5.x86_64
#   - kernel-headers:2.6.18-371.6.1.el5.x86_64
#   - kernel-xen:2.6.18-371.6.1.el5.x86_64
#   - kernel-xen-debuginfo:2.6.18-371.6.1.el5.x86_64
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2014:0285
#
