...
#   - kernel-debug-debuginfo:2.6.18-371.6.1.el5
#   - kernel-debug-devel:2.6.18-371.6.1.el5
#   - kernel-debuginfo:2.6.18-371.6.1.el5
#   - kernel-debuginfo-common:2.6.18-371.6.1.el5
#   - kernel-devel:2.6.18-371.6.1.el5
#   - kernel-headers:2.6.18-371.6.1.el5
#   - kernel-xen:2.6.18-371.6.1.el5
#   - kernel-xen-debuginfo:2.6.18-371.6.1.el5
