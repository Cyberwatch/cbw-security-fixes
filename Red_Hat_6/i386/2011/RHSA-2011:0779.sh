...
#   - avahi-autoipd.i686:0.6.25-11.el6
...
#   - avahi-tools.i686:0.6.25-11.el6
...
#   - avahi-dnsconfd.i686:0.6.25-11.el6
...
#   - avahi-ui-tools.i686:0.6.25-11.el6
#
...
sudo yum install avahi-autoipd.i686-0.6.25 -y 
...
sudo yum install avahi-tools.i686-0.6.25 -y 
...
sudo yum install avahi-dnsconfd.i686-0.6.25 -y 
...
sudo yum install avahi-ui-tools.i686-0.6.25 -y 
