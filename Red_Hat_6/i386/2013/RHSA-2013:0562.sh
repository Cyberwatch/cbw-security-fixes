...
#   - python-saslwrapper.i686:0.18-1.el6_3
#   - ruby-saslwrapper.i686:0.18-1.el6_3
...
sudo yum install rubygems.noarch-1.8.16 -y 
...
sudo yum install python-saslwrapper.i686-0.18 -y 
sudo yum install ruby-saslwrapper.i686-0.18 -y 
