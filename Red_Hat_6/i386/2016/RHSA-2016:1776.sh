...
sudo yum install java-1.6.0-openjdk.i686-1.6.0.40 -y 
sudo yum install java-1.6.0-openjdk-debuginfo.i686-1.6.0.40 -y 
sudo yum install java-1.6.0-openjdk-demo.i686-1.6.0.40 -y 
sudo yum install java-1.6.0-openjdk-devel.i686-1.6.0.40 -y 
sudo yum install java-1.6.0-openjdk-javadoc.i686-1.6.0.40 -y 
sudo yum install java-1.6.0-openjdk-src.i686-1.6.0.40 -y 
