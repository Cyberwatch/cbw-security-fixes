...
#   - krb5-debuginfo:1.8.2-3.el6_0.3.x86_64
#   - krb5-libs:1.8.2-3.el6_0.3.x86_64
#   - krb5-pkinit-openssl:1.8.2-3.el6_0.3.x86_64
#   - krb5-workstation:1.8.2-3.el6_0.3.x86_64
#   - krb5-devel:1.8.2-3.el6_0.3.x86_64
#   - krb5-server:1.8.2-3.el6_0.3.x86_64
#   - krb5-server-ldap:1.8.2-3.el6_0.3.x86_64
#
