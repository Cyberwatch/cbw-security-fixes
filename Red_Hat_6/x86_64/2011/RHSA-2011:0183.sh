...
sudo yum install openoffice.org-debuginfo.i686-3.2.1 -y 
sudo yum install autocorr-af.noarch-3.2.1 -y 
sudo yum install autocorr-bg.noarch-3.2.1 -y 
sudo yum install autocorr-cs.noarch-3.2.1 -y 
sudo yum install autocorr-da.noarch-3.2.1 -y 
sudo yum install autocorr-de.noarch-3.2.1 -y 
sudo yum install autocorr-en.noarch-3.2.1 -y 
sudo yum install autocorr-es.noarch-3.2.1 -y 
sudo yum install autocorr-eu.noarch-3.2.1 -y 
sudo yum install autocorr-fa.noarch-3.2.1 -y 
sudo yum install autocorr-fi.noarch-3.2.1 -y 
sudo yum install autocorr-fr.noarch-3.2.1 -y 
sudo yum install autocorr-ga.noarch-3.2.1 -y 
sudo yum install autocorr-hu.noarch-3.2.1 -y 
sudo yum install autocorr-it.noarch-3.2.1 -y 
sudo yum install autocorr-ja.noarch-3.2.1 -y 
sudo yum install autocorr-ko.noarch-3.2.1 -y 
sudo yum install autocorr-lb.noarch-3.2.1 -y 
sudo yum install autocorr-lt.noarch-3.2.1 -y 
sudo yum install autocorr-mn.noarch-3.2.1 -y 
sudo yum install autocorr-nl.noarch-3.2.1 -y 
sudo yum install autocorr-pl.noarch-3.2.1 -y 
sudo yum install autocorr-pt.noarch-3.2.1 -y 
sudo yum install autocorr-ru.noarch-3.2.1 -y 
sudo yum install autocorr-sk.noarch-3.2.1 -y 
sudo yum install autocorr-sl.noarch-3.2.1 -y 
sudo yum install autocorr-sv.noarch-3.2.1 -y 
sudo yum install autocorr-tr.noarch-3.2.1 -y 
sudo yum install autocorr-vi.noarch-3.2.1 -y 
sudo yum install autocorr-zh.noarch-3.2.1 -y 
