...
#   - java-1.6.0-openjdk:1.6.0.0-1.39.1.9.8.el6_1
#   - java-1.6.0-openjdk-debuginfo:1.6.0.0-1.39.1.9.8.el6_1
#   - java-1.6.0-openjdk-demo:1.6.0.0-1.39.1.9.8.el6_1
#   - java-1.6.0-openjdk-devel:1.6.0.0-1.39.1.9.8.el6_1
#   - java-1.6.0-openjdk-javadoc:1.6.0.0-1.39.1.9.8.el6_1
#   - java-1.6.0-openjdk-src:1.6.0.0-1.39.1.9.8.el6_1
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2011:0856
#
