...
# Script generation date:     2016-11-24 21:14:37 UTC
#
...
sudo yum install jbossas-web.noarch-5.1.1 -y 
sudo yum install jbossas-web-client.noarch-5.1.1 -y 
sudo yum install jbossas-web-ws-native.noarch-5.1.1 -y 
sudo yum install jbossas-ws-cxf-ewp.noarch-5.1.1 -y 
...
sudo yum install rh-ewp-docs.noarch-5.1.1 -y 
sudo yum install rh-ewp-docs-examples.noarch-5.1.1 -y 
