...
# Script generation date:     2016-11-24 21:14:38 UTC
#
...
#   - jboss-messaging.noarch:1.4.8-6.SP1.1.ep5.el6
...
#   - jbossas.noarch:5.1.1-17.ep5.el6
#   - jbossas-client.noarch:5.1.1-17.ep5.el6
#   - jbossas-messaging511.noarch:5.1.1-17.4.ep5.el6
#   - jbossas-ws-cxf.noarch:5.1.1-6.ep5.el6
#   - jbossas-ws-native.noarch:5.1.1-17.ep5.el6
...
#   - netty.noarch:3.2.3-5.3.ep5.el6
...
#   - rh-eap-docs.noarch:5.1.1-6.ep5.el6
#   - rh-eap-docs-examples.noarch:5.1.1-6.ep5.el6
...
sudo yum install codehaus-jackson.noarch-1.3.5 -y 
sudo yum install codehaus-jackson-core-asl.noarch-1.3.5 -y 
sudo yum install codehaus-jackson-jaxrs.noarch-1.3.5 -y 
sudo yum install codehaus-jackson-mapper-asl.noarch-1.3.5 -y 
...
sudo yum install jaxbintros.noarch-1.0.0 -y 
sudo yum install jaxen.noarch-1.1.2 -y 
...
sudo yum install jboss-bootstrap.noarch-1.0.1 -y 
sudo yum install jboss-cache-core.noarch-3.2.7 -y 
sudo yum install jboss-cache-pojo.noarch-3.0.0 -y 
sudo yum install jboss-cl.noarch-2.0.9 -y 
sudo yum install jboss-cluster-ha-client.noarch-1.1.1 -y 
sudo yum install jboss-cluster-ha-server-api.noarch-1.2.0 -y 
...
sudo yum install jboss-ejb-3.0-api.noarch-5.0.1 -y 
...
sudo yum install jboss-ejb3-core.noarch-1.3.7 -y 
...
sudo yum install jboss-ejb3-interceptors.noarch-1.0.7 -y 
...
sudo yum install jboss-ejb3-metrics-deployer.noarch-1.1.0 -y 
...
sudo yum install jboss-jacc-1.1-api.noarch-5.0.1 -y 
sudo yum install jboss-jad-1.2-api.noarch-5.0.1 -y 
sudo yum install jboss-jaspi-1.0-api.noarch-5.0.1 -y 
...
sudo yum install jboss-jca-1.5-api.noarch-5.0.1 -y 
...
sudo yum install jboss-metadata.noarch-1.0.6 -y 
...
sudo yum install jboss-reflect.noarch-2.0.3 -y 
sudo yum install jboss-remoting.noarch-2.5.4 -y 
sudo yum install jboss-remoting-aspects.noarch-1.0.3 -y 
sudo yum install jboss-seam-int.noarch-5.1.0 -y 
sudo yum install jboss-seam2.noarch-2.2.4.EAP5 -y 
sudo yum install jboss-seam2-docs.noarch-2.2.4.EAP5 -y 
sudo yum install jboss-seam2-examples.noarch-2.2.4.EAP5 -y 
sudo yum install jboss-seam2-runtime.noarch-2.2.4.EAP5 -y 
sudo yum install jboss-security-aspects.noarch-1.0.0 -y 
sudo yum install jboss-security-negotiation.noarch-2.0.3 -y 
sudo yum install jboss-security-spi.noarch-2.0.4 -y 
sudo yum install jboss-security-xacml.noarch-2.0.5 -y 
sudo yum install jboss-serialization.noarch-1.0.5 -y 
sudo yum install jboss-specs-parent.noarch-1.0.0 -y 
sudo yum install jboss-threads.noarch-1.0.0 -y 
sudo yum install jboss-transaction-1.0.1-api.noarch-5.0.1 -y 
sudo yum install jboss-transaction-1.0.1-api.noarch-5.0.1 -y 
sudo yum install jboss-transaction-aspects.noarch-1.0.0 -y 
sudo yum install jboss-vfs2.noarch-2.2.0 -y 
sudo yum install jboss-xnio-base.noarch-1.2.1 -y 
sudo yum install jboss-xnio-metadata.noarch-1.0.1 -y 
sudo yum install jboss5-libs.noarch-5.1.0 -y 
sudo yum install jbossas.noarch-5.1.1 -y 
sudo yum install jbossas-client.noarch-5.1.1 -y 
sudo yum install jbossas-messaging511.noarch-5.1.1 -y 
sudo yum install jbossas-ws-cxf.noarch-5.1.1 -y 
sudo yum install jbossas-ws-native.noarch-5.1.1 -y 
...
sudo yum install jbossweb.noarch-2.1.11 -y 
sudo yum install jbossweb-el-1.0-api.noarch-2.1.11 -y 
sudo yum install jbossweb-jsp-2.1-api.noarch-2.1.11 -y 
sudo yum install jbossweb-lib.noarch-2.1.11 -y 
sudo yum install jbossweb-servlet-2.5-api.noarch-2.1.11 -y 
...
sudo yum install jbossxb2.noarch-2.0.1 -y 
...
sudo yum install jettison.noarch-1.2 -y 
sudo yum install jfreechart.noarch-1.0.13 -y 
sudo yum install jgroups.noarch-2.6.19 -y 
...
sudo yum install juddi.noarch-2.0.1 -y 
...
sudo yum install relaxngDatatype.noarch-1.0 -y 
...
sudo yum install rh-eap-docs.noarch-5.1.1 -y 
sudo yum install rh-eap-docs-examples.noarch-5.1.1 -y 
...
sudo yum install sun-xsom.noarch-20070515 -y 
sudo yum install velocity.noarch-1.6.3 -y 
sudo yum install werken-xpath.noarch-0.9.4 -y 
sudo yum install ws-commons-XmlSchema.noarch-1.4.5 -y 
sudo yum install ws-commons-axiom.noarch-1.2.7 -y 
sudo yum install ws-commons-neethi.noarch-2.0.4 -y 
sudo yum install ws-scout.noarch-1.1.1 -y 
sudo yum install wsdl4j16.noarch-1.6.2 -y 
sudo yum install wss4j.noarch-1.5.10 -y 
...
sudo yum install xml-security.noarch-1.4.3 -y 
