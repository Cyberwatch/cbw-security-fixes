...
#   - condor-ec2-enhanced:1.2-2.el6.noarch
#   - condor-ec2-enhanced-hooks:1.2-3.el6.noarch
#   - condor-job-hooks:1.5-4.el6.noarch
#   - condor-low-latency:1.2-2.el6.noarch
#   - condor-wallaby-base-db:1.14-1.el6.noarch
#   - condor-wallaby-client:4.1-4.el6.noarch
#   - condor-wallaby-tools:4.1-4.el6.noarch
#   - python-condorec2e:1.2-3.el6.noarch
#   - python-condorutils:1.5-4.el6.noarch
#   - python-wallabyclient:4.1-4.el6.noarch
#   - ruby-rhubarb:0.4.0-1.el6.noarch
...
#   - condor-kbdd:7.6.3-0.3.el6.x86_64
#   - condor-qmf:7.6.3-0.3.el6.x86_64
#   - condor-vm-gahp:7.6.3-0.3.el6.x86_64
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2011:1250
#
