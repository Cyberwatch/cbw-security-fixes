# CYBERWATCH SAS - 2016
#
# Security fix for RHSA-2011:1299
#
# Security announcement date: 2011-09-15 19:51:44 UTC
# Script generation date:     2016-01-11 19:12:51 UTC
#
# Operating System: Red Hat 6
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - spacewalk-base:1.2.7-20.el6sat.noarch
#   - spacewalk-base-minimal:1.2.7-20.el6sat.noarch
#   - spacewalk-config:1.2.2-7.el6sat.noarch
#   - spacewalk-dobby:1.2.7-20.el6sat.noarch
#   - spacewalk-grail:1.2.7-20.el6sat.noarch
#   - spacewalk-html:1.2.7-20.el6sat.noarch
#   - spacewalk-java:1.2.39-98.el6sat.noarch
#   - spacewalk-java-config:1.2.39-98.el6sat.noarch
#   - spacewalk-java-lib:1.2.39-98.el6sat.noarch
#   - spacewalk-java-oracle:1.2.39-98.el6sat.noarch
#   - spacewalk-pxt:1.2.7-20.el6sat.noarch
#   - spacewalk-sniglets:1.2.7-20.el6sat.noarch
#   - spacewalk-taskomatic:1.2.39-98.el6sat.noarch
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2011:1299
#
