...
#   - xorg-x11-server-Xephyr:1.7.7-29.el6_1.2
#   - xorg-x11-server-Xorg:1.7.7-29.el6_1.2
#   - xorg-x11-server-common:1.7.7-29.el6_1.2
#   - xorg-x11-server-debuginfo:1.7.7-29.el6_1.2
#   - xorg-x11-server-source:1.7.7-29.el6_1.2
#   - xorg-x11-server-Xdmx:1.7.7-29.el6_1.2
#   - xorg-x11-server-Xnest:1.7.7-29.el6_1.2
#   - xorg-x11-server-Xvfb:1.7.7-29.el6_1.2
#   - xorg-x11-server-devel:1.7.7-29.el6_1.2
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2011:1359
#
