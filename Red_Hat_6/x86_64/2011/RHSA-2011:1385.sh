...
#   - kdelibs3.x86_64:3.5.10-24.el6_1.1
#   - kdelibs3-debuginfo.x86_64:3.5.10-24.el6_1.1
#   - kdelibs3-devel.i686:3.5.10-24.el6_1.1
#   - kdelibs3-apidocs.noarch:3.5.10-24.el6_1.1
#   - kdelibs3-devel.x86_64:3.5.10-24.el6_1.1
#
...
sudo yum install kdelibs3.x86_64-3.5.10 -y 
sudo yum install kdelibs3-debuginfo.x86_64-3.5.10 -y 
sudo yum install kdelibs3-devel.i686-3.5.10 -y 
sudo yum install kdelibs3-apidocs.noarch-3.5.10 -y 
sudo yum install kdelibs3-devel.x86_64-3.5.10 -y 
