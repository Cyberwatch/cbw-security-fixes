...
#   - kernel-debug-debuginfo:2.6.32-220.7.1.el6
#   - kernel-debug-devel:2.6.32-220.7.1.el6
#   - kernel-debuginfo:2.6.32-220.7.1.el6
#   - kernel-debuginfo-common-x86_64:2.6.32-220.7.1.el6
#   - kernel-devel:2.6.32-220.7.1.el6
#   - kernel-headers:2.6.32-220.7.1.el6
#   - perf:2.6.32-220.7.1.el6
#   - perf-debuginfo:2.6.32-220.7.1.el6
