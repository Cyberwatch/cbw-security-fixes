...
# Script generation date:     2015-09-23 06:10:46 UTC
#
# Operating System: Red Hat 6
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - firefox:10.0.3-1.el6_2
#   - firefox-debuginfo:10.0.3-1.el6_2
#   - xulrunner:10.0.3-1.el6_2
#   - xulrunner-debuginfo:10.0.3-1.el6_2
#   - xulrunner-devel:10.0.3-1.el6_2
#
