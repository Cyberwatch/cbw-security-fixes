...
#   - xorg-x11-server-Xephyr:1.10.6-1.el6
#   - xorg-x11-server-Xorg:1.10.6-1.el6
#   - xorg-x11-server-common:1.10.6-1.el6
#   - xorg-x11-server-debuginfo:1.10.6-1.el6
#   - xorg-x11-server-source:1.10.6-1.el6
#   - xorg-x11-server-Xdmx:1.10.6-1.el6
#   - xorg-x11-server-Xnest:1.10.6-1.el6
#   - xorg-x11-server-Xvfb:1.10.6-1.el6
#   - xorg-x11-server-devel:1.10.6-1.el6
#
