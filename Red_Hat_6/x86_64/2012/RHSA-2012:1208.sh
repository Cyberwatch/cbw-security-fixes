...
#   - glibc-debuginfo:2.12-1.80.el6_3.5
#   - glibc-debuginfo-common:2.12-1.80.el6_3.5
#   - glibc-devel:2.12-1.80.el6_3.5
#   - glibc-headers:2.12-1.80.el6_3.5
#   - glibc-utils:2.12-1.80.el6_3.5
#   - nscd:2.12-1.80.el6_3.5
#   - glibc-static:2.12-1.80.el6_3.5
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2012:1208
#
