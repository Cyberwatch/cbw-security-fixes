# CYBERWATCH SAS - 2016
#
# Security fix for RHSA-2012:1386
#
# Security announcement date: 2012-10-17 16:18:11 UTC
...
#   - java-1.7.0-openjdk:1.7.0.9-2.3.3.el6_3.1.x86_64
#   - java-1.7.0-openjdk-debuginfo:1.7.0.9-2.3.3.el6_3.1.x86_64
#   - java-1.7.0-openjdk-javadoc:1.7.0.9-2.3.3.el6_3.1.noarch
#   - java-1.7.0-openjdk-demo:1.7.0.9-2.3.3.el6_3.1.x86_64
#   - java-1.7.0-openjdk-devel:1.7.0.9-2.3.3.el6_3.1.x86_64
#   - java-1.7.0-openjdk-src:1.7.0.9-2.3.3.el6_3.1.x86_64
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2012:1386
#
