...
#   - glusterfs-debuginfo:3.3.0.5rhs-37.el6rhs
#   - glusterfs-devel:3.3.0.5rhs-37.el6rhs
#   - glusterfs-fuse:3.3.0.5rhs-37.el6rhs
#   - glusterfs-geo-replication:3.3.0.5rhs-37.el6rhs
#   - glusterfs-rdma:3.3.0.5rhs-37.el6rhs
#   - glusterfs-server:3.3.0.5rhs-37.el6rhs
#   - glusterfs:3.3.0.5rhs-37.el6
#   - glusterfs-debuginfo:3.3.0.5rhs-37.el6
#   - glusterfs-devel:3.3.0.5rhs-37.el6
#   - glusterfs-fuse:3.3.0.5rhs-37.el6
#   - glusterfs-rdma:3.3.0.5rhs-37.el6
#
