...
#   - rhevm:3.1.0-43.el6ev
#   - rhevm-backend:3.1.0-43.el6ev
#   - rhevm-config:3.1.0-43.el6ev
#   - rhevm-dbscripts:3.1.0-43.el6ev
#   - rhevm-genericapi:3.1.0-43.el6ev
#   - rhevm-notification-service:3.1.0-43.el6ev
#   - rhevm-restapi:3.1.0-43.el6ev
#   - rhevm-setup:3.1.0-43.el6ev
#   - rhevm-setup-plugin-allinone:3.1.0-43.el6ev
#   - rhevm-tools-common:3.1.0-43.el6ev
#   - rhevm-userportal:3.1.0-43.el6ev
#   - rhevm-webadmin-portal:3.1.0-43.el6ev
#
