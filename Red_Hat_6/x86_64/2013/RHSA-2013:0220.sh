...
sudo yum install rhc.noarch-1.3.2 -y 
sudo yum install openshift-console.noarch-0.0.13 -y 
sudo yum install openshift-origin-broker.noarch-1.0.10 -y 
sudo yum install openshift-origin-broker-util.noarch-1.0.14 -y 
...
sudo yum install rubygem-openshift-origin-auth-remote-user.noarch-1.0.4 -y 
sudo yum install rubygem-openshift-origin-common.noarch-1.29.5.2 -y 
sudo yum install rubygem-openshift-origin-console.noarch-1.0.6 -y 
sudo yum install rubygem-openshift-origin-console-doc.noarch-1.0.6 -y 
sudo yum install rubygem-openshift-origin-controller.noarch-1.0.11 -y 
sudo yum install rubygem-openshift-origin-dns-bind.noarch-1.0.2 -y 
sudo yum install rubygem-openshift-origin-msg-broker-mcollective.noarch-1.0.4 -y 
