...
sudo yum install katello-common.noarch-1.2.1.1 -y 
sudo yum install katello-configure.noarch-1.2.3.1 -y 
sudo yum install katello-glue-candlepin.noarch-1.2.1.1 -y 
sudo yum install katello-headpin.noarch-1.2.1.1 -y 
sudo yum install katello-headpin-all.noarch-1.2.1.1 -y 
sudo yum install rubygem-actionpack.noarch-3.0.10 -y 
