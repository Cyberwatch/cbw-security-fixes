...
#   - ruby193-ruby-irb:1.9.3.327-28.el6
#   - ruby193-rubygem-minitest:2.5.1-28.el6
#   - ruby193-rubygem-rake:0.9.2.2-28.el6
#   - ruby193-rubygems:1.8.23-28.el6
#   - ruby193-rubygems-devel:1.8.23-28.el6
#   - rubygem-json-doc:1.7.3-2.el6op
#   - rubygem-rdoc:3.8-9.el6op
#   - rubygem-rdoc-doc:3.8-9.el6op
#   - ruby193-ruby:1.9.3.327-28.el6
#   - ruby193-ruby-debuginfo:1.9.3.327-28.el6
#   - ruby193-ruby-devel:1.9.3.327-28.el6
#   - ruby193-ruby-doc:1.9.3.327-28.el6
#   - ruby193-ruby-libs:1.9.3.327-28.el6
#   - ruby193-ruby-tcltk:1.9.3.327-28.el6
#   - ruby193-rubygem-bigdecimal:1.1.0-28.el6
#   - ruby193-rubygem-io-console:0.3-28.el6
#   - ruby193-rubygem-json:1.5.4-28.el6
#   - ruby193-rubygem-rdoc:3.9.4-28.el6
