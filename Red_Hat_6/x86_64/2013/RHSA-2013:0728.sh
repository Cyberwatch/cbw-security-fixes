...
#   - ruby193-rubygem-activesupport:3.2.8-4.el6
#   - ruby193-rubygem-bson:1.5.2-6.el6op
#   - ruby193-rubygem-chunky_png:1.2.6-3.el6op
#   - ruby193-rubygem-ci_reporter:1.7.2-4.el6op
#   - ruby193-rubygem-compass:0.12.2-4.el6op
#   - ruby193-rubygem-haml:3.1.7-3.el6op
#   - ruby193-rubygem-http_connection:1.4.1-7.el6
#   - ruby193-rubygem-rack:1.4.1-5.el6
#   - ruby193-rubygem-rack-test:0.6.1-3.el6
#   - ruby193-rubygem-rspec:2.11.0-2.el6
#   - ruby193-rubygem-treetop:1.4.10-6.el6
#   - ruby193-rubygem-xml-simple:1.0.12-10.el6op
#   - ruby193-rubygem-bcrypt-ruby:3.0.1-7.el6
#   - ruby193-rubygem-bcrypt-ruby-debuginfo:3.0.1-7.el6
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2013:0728
#
...
sudo yum install ruby193-rubygem-treetop-1.4.10 -y 
sudo yum install ruby193-rubygem-xml-simple-1.0.12 -y 
sudo yum install ruby193-rubygem-bcrypt-ruby-3.0.1 -y 
sudo yum install ruby193-rubygem-bcrypt-ruby-debuginfo-3.0.1 -y 
