# CYBERWATCH SAS - 2016
#
# Security fix for RHSA-2013:0888
#
# Security announcement date: 2013-06-10 21:02:14 UTC
...
#   - rhevm.noarch:3.2.0-11.30.el6ev
#   - rhevm-backend.noarch:3.2.0-11.30.el6ev
#   - rhevm-config.noarch:3.2.0-11.30.el6ev
#   - rhevm-dbscripts.noarch:3.2.0-11.30.el6ev
#   - rhevm-genericapi.noarch:3.2.0-11.30.el6ev
#   - rhevm-notification-service.noarch:3.2.0-11.30.el6ev
#   - rhevm-restapi.noarch:3.2.0-11.30.el6ev
#   - rhevm-setup.noarch:3.2.0-11.30.el6ev
#   - rhevm-setup-plugin-allinone.noarch:3.2.0-11.30.el6ev
#   - rhevm-tools-common.noarch:3.2.0-11.30.el6ev
#   - rhevm-userportal.noarch:3.2.0-11.30.el6ev
#   - rhevm-webadmin-portal.noarch:3.2.0-11.30.el6ev
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2013:0888
#
