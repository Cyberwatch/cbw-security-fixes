...
# Script generation date:     2016-01-28 19:14:38 UTC
#
# Operating System: Red Hat 6
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - qemu-guest-agent:0.12.1.2-2.355.el6_4.6.x86_64
#   - qemu-img:0.12.1.2-2.355.el6_4.6.x86_64
#   - qemu-kvm:0.12.1.2-2.355.el6_4.6.x86_64
#   - qemu-kvm-debuginfo:0.12.1.2-2.355.el6_4.6.x86_64
#   - qemu-kvm-tools:0.12.1.2-2.355.el6_4.6.x86_64
