...
#   - rubygem-file-tail-doc:1.0.5-4.el6op.noarch
#   - rubygem-spruz:0.2.5-4.el6op.noarch
#   - rubygem-spruz-doc:0.2.5-4.el6op.noarch
#   - mod_passenger:3.0.21-3.el6op.x86_64
...
#   - rubygem-passenger-debuginfo:3.0.21-3.el6op.x86_64
#   - rubygem-passenger-devel:3.0.21-3.el6op.x86_64
#   - rubygem-passenger-doc:3.0.21-3.el6op.x86_64
#   - rubygem-passenger-native:3.0.21-3.el6op.x86_64
#   - rubygem-passenger-native-libs:3.0.21-3.el6op.x86_64
#
...
sudo yum install rubygem-file-tail-doc-1.0.5 -y 
sudo yum install rubygem-spruz-0.2.5 -y 
sudo yum install rubygem-spruz-doc-0.2.5 -y 
...
sudo yum install rubygem-passenger-doc-3.0.21 -y 
