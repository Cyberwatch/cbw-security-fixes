# CYBERWATCH SAS - 2016
#
# Security fix for RHSA-2013:1136
#
# Security announcement date: 2013-08-05 16:23:10 UTC
...
#   - rubygem-file-tail-doc.noarch:1.0.5-4.el6op
#   - rubygem-spruz.noarch:0.2.5-4.el6op
#   - rubygem-spruz-doc.noarch:0.2.5-4.el6op
#   - mod_passenger.x86_64:3.0.21-3.el6op
...
#   - rubygem-passenger.x86_64:3.0.21-3.el6op
#   - rubygem-passenger-debuginfo.x86_64:3.0.21-3.el6op
#   - rubygem-passenger-devel.x86_64:3.0.21-3.el6op
#   - rubygem-passenger-doc.x86_64:3.0.21-3.el6op
#   - rubygem-passenger-native.x86_64:3.0.21-3.el6op
#   - rubygem-passenger-native-libs.x86_64:3.0.21-3.el6op
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2013:1136
#
# Licence: Released under The MIT License (MIT), See LICENSE FILE
sudo yum install rubygem-file-tail.noarch-1.0.5 -y 
sudo yum install rubygem-file-tail-doc.noarch-1.0.5 -y 
sudo yum install rubygem-spruz.noarch-0.2.5 -y 
sudo yum install rubygem-spruz-doc.noarch-0.2.5 -y 
...
sudo yum install rubygem-passenger-doc.x86_64-3.0.21 -y 
