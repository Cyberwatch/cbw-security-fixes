...
#   - jboss-as-client-all.noarch:7.2.0-9.Final_redhat_9.ep6.el6
#   - jboss-ejb-client.noarch:1.0.21-2.Final_redhat_2.ep6.el6
#   - jboss-remote-naming.noarch:1.0.6-3.Final_redhat_3.ep6.el6
#
