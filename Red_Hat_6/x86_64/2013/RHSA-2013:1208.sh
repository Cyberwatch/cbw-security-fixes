...
# Script generation date:     2016-01-11 19:14:23 UTC
#
# Operating System: Red Hat 6
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - apache-commons-beanutils:1.8.3-12.redhat_3.2.ep6.el6.noarch
#   - apache-cxf:2.6.8-8.redhat_7.1.ep6.el6.noarch
#   - apache-cxf-xjc-utils:2.6.0-2.redhat_4.1.ep6.el6.noarch
#   - cxf-xjc-boolean:2.6.0-2.redhat_4.1.ep6.el6.noarch
#   - cxf-xjc-dv:2.6.0-2.redhat_4.1.ep6.el6.noarch
#   - cxf-xjc-ts:2.6.0-2.redhat_4.1.ep6.el6.noarch
#   - hibernate4:4.2.0-7.SP1_redhat_1.ep6.el6.noarch
#   - hibernate4-core:4.2.0-7.SP1_redhat_1.ep6.el6.noarch
#   - hibernate4-entitymanager:4.2.0-7.SP1_redhat_1.ep6.el6.noarch
...
#   - infinispan:5.2.7-1.Final_redhat_1.ep6.el6.noarch
#   - infinispan-cachestore-jdbc:5.2.7-1.Final_redhat_1.ep6.el6.noarch
#   - infinispan-cachestore-remote:5.2.7-1.Final_redhat_1.ep6.el6.noarch
#   - infinispan-client-hotrod:5.2.7-1.Final_redhat_1.ep6.el6.noarch
#   - infinispan-core:5.2.7-1.Final_redhat_1.ep6.el6.noarch
#   - ironjacamar:1.0.19-1.Final_redhat_2.ep6.el6.noarch
#   - ironjacamar-common-api:1.0.19-1.Final_redhat_2.ep6.el6.noarch
#   - ironjacamar-common-impl:1.0.19-1.Final_redhat_2.ep6.el6.noarch
#   - ironjacamar-common-spi:1.0.19-1.Final_redhat_2.ep6.el6.noarch
#   - ironjacamar-core-api:1.0.19-1.Final_redhat_2.ep6.el6.noarch
#   - ironjacamar-core-impl:1.0.19-1.Final_redhat_2.ep6.el6.noarch
#   - ironjacamar-deployers-common:1.0.19-1.Final_redhat_2.ep6.el6.noarch
#   - ironjacamar-jdbc:1.0.19-1.Final_redhat_2.ep6.el6.noarch
#   - ironjacamar-spec-api:1.0.19-1.Final_redhat_2.ep6.el6.noarch
#   - ironjacamar-validator:1.0.19-1.Final_redhat_2.ep6.el6.noarch
#   - jaxbintros:1.0.2-16.GA_redhat_6.ep6.el6.noarch
#   - jboss-aesh:0.33.7-2.redhat_2.1.ep6.el6.noarch
#   - jboss-as-appclient:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-cli:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-client-all:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-clustering:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-cmp:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-configadmin:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-connector:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-console:1.5.6-2.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-controller:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-controller-client:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-deployment-repository:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-deployment-scanner:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-domain-http:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-domain-management:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-ee:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-ee-deployment:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-ejb3:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-embedded:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-host-controller:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-jacorb:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-jaxr:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-jaxrs:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-jdr:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-jmx:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-jpa:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-jsf:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-jsr77:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-logging:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-mail:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-management-client-content:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-messaging:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-modcluster:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-naming:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-network:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-osgi:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-osgi-configadmin:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-osgi-service:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-platform-mbean:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-pojo:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-process-controller:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-protocol:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-remoting:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-sar:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-security:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-server:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-system-jmx:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-threads:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-transactions:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-version:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-web:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-webservices:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-weld:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-as-xts:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jboss-ejb-client:1.0.23-1.Final_redhat_1.ep6.el6.noarch
#   - jboss-hal:1.5.7-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-invocation:1.1.2-1.Final_redhat_1.ep6.el6.noarch
#   - jboss-jsp-api_2.2_spec:1.0.1-6.Final_redhat_2.ep6.el6.noarch
#   - jboss-logmanager:1.4.3-1.Final_redhat_1.ep6.el6.noarch
#   - jboss-marshalling:1.3.18-1.GA_redhat_1.1.ep6.el6.noarch
#   - jboss-modules:1.2.2-1.Final_redhat_1.ep6.el6.noarch
#   - jboss-remote-naming:1.0.7-1.Final_redhat_1.ep6.el6.noarch
#   - jboss-security-negotiation:2.2.5-2.Final_redhat_2.ep6.el6.noarch
#   - jboss-stdio:1.0.2-1.GA_redhat_1.ep6.el6.noarch
#   - jbossas-appclient:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jbossas-bundles:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jbossas-core:7.2.1-6.Final_redhat_10.1.ep6.el6.noarch
#   - jbossas-domain:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jbossas-javadocs:7.2.1-2.Final_redhat_10.ep6.el6.noarch
#   - jbossas-modules-eap:7.2.1-9.Final_redhat_10.1.ep6.el6.noarch
#   - jbossas-product-eap:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jbossas-standalone:7.2.1-6.Final_redhat_10.1.ep6.el6.noarch
#   - jbossas-welcome-content-eap:7.2.1-5.Final_redhat_10.1.ep6.el6.noarch
#   - jbossts:4.17.7-4.Final_redhat_4.ep6.el6.noarch
#   - jbossweb:7.2.2-1.Final_redhat_1.1.ep6.el6.noarch
#   - jbossws-common:2.1.3-1.Final_redhat_1.ep6.el6.noarch
#   - jbossws-cxf:4.1.4-7.Final_redhat_7.ep6.el6.noarch
#   - jbossws-spi:2.1.3-1.Final_redhat_1.ep6.el6.noarch
#   - jcip-annotations-eap6:1.0-4.redhat_4.ep6.el6.noarch
#   - jgroups:3.2.10-1.Final_redhat_2.2.ep6.el6.noarch
#   - log4j-jboss-logmanager:1.0.2-1.Final_redhat_1.ep6.el6.noarch
#   - netty:3.6.6-2.Final_redhat_1.1.ep6.el6.noarch
#   - opensaml:2.5.1-2.redhat_2.1.ep6.el6.noarch
#   - openws:1.4.2-10.redhat_4.1.ep6.el6.noarch
#   - picketbox:4.0.17-3.SP2_redhat_2.1.ep6.el6.noarch
#   - picketlink-federation:2.1.6.3-2.Final_redhat_2.2.ep6.el6.noarch
#   - wss4j:1.6.10-1.redhat_1.ep6.el6.noarch
#   - xml-security:1.5.5-1.redhat_1.ep6.el6.noarch
#   - apache-commons-daemon-jsvc-eap6:1.0.15-2.redhat_2.ep6.el6.x86_64
#   - apache-commons-daemon-jsvc-eap6-debuginfo:1.0.15-2.redhat_2.ep6.el6.x86_64
#   - hornetq-native:2.3.5-1.Final_redhat_1.ep6.el6.x86_64
#   - hornetq-native-debuginfo:2.3.5-1.Final_redhat_1.ep6.el6.x86_64
...
#   - jbossas-hornetq-native:2.3.5-1.Final_redhat_1.ep6.el6.x86_64
