...
#   - rhevm-backend:3.2.3-0.42.el6ev
#   - rhevm-config:3.2.3-0.42.el6ev
#   - rhevm-dbscripts:3.2.3-0.42.el6ev
#   - rhevm-genericapi:3.2.3-0.42.el6ev
#   - rhevm-notification-service:3.2.3-0.42.el6ev
#   - rhevm-restapi:3.2.3-0.42.el6ev
#   - rhevm-setup:3.2.3-0.42.el6ev
#   - rhevm-setup-plugin-allinone:3.2.3-0.42.el6ev
#   - rhevm-tools-common:3.2.3-0.42.el6ev
#   - rhevm-userportal:3.2.3-0.42.el6ev
#   - rhevm-webadmin-portal:3.2.3-0.42.el6ev
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2013:1210
#
