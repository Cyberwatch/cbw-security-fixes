...
#   - xorg-x11-server-Xephyr:1.13.0-11.1.el6_4.2
#   - xorg-x11-server-Xorg:1.13.0-11.1.el6_4.2
#   - xorg-x11-server-common:1.13.0-11.1.el6_4.2
#   - xorg-x11-server-debuginfo:1.13.0-11.1.el6_4.2
#   - xorg-x11-server-source:1.13.0-11.1.el6_4.2
#   - xorg-x11-server-Xdmx:1.13.0-11.1.el6_4.2
#   - xorg-x11-server-Xnest:1.13.0-11.1.el6_4.2
#   - xorg-x11-server-Xvfb:1.13.0-11.1.el6_4.2
#   - xorg-x11-server-devel:1.13.0-11.1.el6_4.2
#
# Last versions recommanded by security team:
#   - xorg-x11-server-Xephyr:1.15.0-26.el6_6
#   - xorg-x11-server-Xorg:1.15.0-26.el6_6
#   - xorg-x11-server-common:1.15.0-26.el6_6
#   - xorg-x11-server-debuginfo:1.15.0-26.el6_6
