...
#   - kernel-doc:2.6.32-358.23.2.el6
#   - kernel-firmware:2.6.32-358.23.2.el6
#   - kernel:2.6.32-358.23.2.el6
#   - kernel-debug:2.6.32-358.23.2.el6
#   - kernel-debug-debuginfo:2.6.32-358.23.2.el6
#   - kernel-debug-devel:2.6.32-358.23.2.el6
#   - kernel-debuginfo:2.6.32-358.23.2.el6
#   - kernel-debuginfo-common-x86_64:2.6.32-358.23.2.el6
#   - kernel-devel:2.6.32-358.23.2.el6
#   - kernel-headers:2.6.32-358.23.2.el6
#   - perf:2.6.32-358.23.2.el6
#   - perf-debuginfo:2.6.32-358.23.2.el6
#   - python-perf-debuginfo:2.6.32-358.23.2.el6
#   - python-perf:2.6.32-358.23.2.el6
#
