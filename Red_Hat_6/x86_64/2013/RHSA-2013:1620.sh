...
#   - xorg-x11-server-Xephyr:1.13.0-23.el6
#   - xorg-x11-server-Xorg:1.13.0-23.el6
#   - xorg-x11-server-common:1.13.0-23.el6
#   - xorg-x11-server-debuginfo:1.13.0-23.el6
#   - xorg-x11-server-source:1.13.0-23.el6
#   - xorg-x11-server-Xdmx:1.13.0-23.el6
#   - xorg-x11-server-Xnest:1.13.0-23.el6
#   - xorg-x11-server-Xvfb:1.13.0-23.el6
#   - xorg-x11-server-devel:1.13.0-23.el6
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2013:1620
#
