...
# Script generation date:     2016-01-06 19:12:10 UTC
#
...
#   - apache-cxf:2.7.7-1.redhat_1.1.ep6.el6.noarch
#   - apache-cxf-xjc-utils:2.6.1-4.redhat_2.1.ep6.el6.noarch
#   - apache-mime4j:0.6-8.redhat_3.1.ep6.el6.noarch
#   - atinject-eap6:1-5.redhat_4.1.ep6.el6.noarch
#   - cxf-xjc-boolean:2.6.1-4.redhat_2.1.ep6.el6.noarch
#   - cxf-xjc-dv:2.6.1-4.redhat_2.1.ep6.el6.noarch
#   - cxf-xjc-ts:2.6.1-4.redhat_2.1.ep6.el6.noarch
#   - dom4j-eap6:1.6.1-20.redhat_6.1.ep6.el6.noarch
#   - glassfish-jaxb-eap6:2.2.5-17.redhat_7.2.ep6.el6.noarch
#   - glassfish-jsf-eap6:2.1.19-2.3.redhat_2.ep6.el6.noarch
#   - glassfish-jsf12-eap6:1.2_15-5.b01_redhat_8.1.ep6.el6.noarch
#   - gnu-getopt:1.0.13-3.redhat_4.1.ep6.el6.noarch
#   - hibernate4-core-eap6:4.2.7-3.3.SP1_redhat_3.ep6.el6.noarch
#   - hibernate4-eap6:4.2.7-3.3.SP1_redhat_3.ep6.el6.noarch
#   - hibernate4-entitymanager-eap6:4.2.7-3.3.SP1_redhat_3.ep6.el6.noarch
#   - hibernate4-envers-eap6:4.2.7-3.3.SP1_redhat_3.ep6.el6.noarch
#   - hibernate4-infinispan-eap6:4.2.7-3.3.SP1_redhat_3.ep6.el6.noarch
#   - hornetq:2.3.12-1.Final_redhat_1.1.ep6.el6.noarch
#   - httpserver:1.0.1-4.Final_redhat_3.1.ep6.el6.noarch
#   - infinispan:5.2.7-2.Final_redhat_2.1.ep6.el6.noarch
#   - infinispan-cachestore-jdbc:5.2.7-2.Final_redhat_2.1.ep6.el6.noarch
#   - infinispan-cachestore-remote:5.2.7-2.Final_redhat_2.1.ep6.el6.noarch
#   - infinispan-client-hotrod:5.2.7-2.Final_redhat_2.1.ep6.el6.noarch
#   - infinispan-core:5.2.7-2.Final_redhat_2.1.ep6.el6.noarch
#   - ironjacamar-common-api-eap6:1.0.23-1.3.Final_redhat_1.ep6.el6.noarch
#   - ironjacamar-common-impl-eap6:1.0.23-1.3.Final_redhat_1.ep6.el6.noarch
#   - ironjacamar-common-spi-eap6:1.0.23-1.3.Final_redhat_1.ep6.el6.noarch
#   - ironjacamar-core-api-eap6:1.0.23-1.3.Final_redhat_1.ep6.el6.noarch
#   - ironjacamar-core-impl-eap6:1.0.23-1.3.Final_redhat_1.ep6.el6.noarch
#   - ironjacamar-deployers-common-eap6:1.0.23-1.3.Final_redhat_1.ep6.el6.noarch
#   - ironjacamar-eap6:1.0.23-1.3.Final_redhat_1.ep6.el6.noarch
#   - ironjacamar-jdbc-eap6:1.0.23-1.3.Final_redhat_1.ep6.el6.noarch
#   - ironjacamar-spec-api-eap6:1.0.23-1.3.Final_redhat_1.ep6.el6.noarch
#   - ironjacamar-validator-eap6:1.0.23-1.3.Final_redhat_1.ep6.el6.noarch
#   - jacorb-jboss:2.3.2-12.redhat_5.1.ep6.el6.noarch
...
#   - jbosgi-metadata:2.2.0-2.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-aesh:0.33.8-1.redhat_1.1.ep6.el6.noarch
#   - jboss-as-appclient:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-cli:7.3.0-5.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-client-all:7.3.0-7.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-clustering:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-cmp:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-configadmin:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-connector:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-console:2.0.6-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-as-controller:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-controller-client:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-core-security:7.3.0-7.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-deployment-repository:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-deployment-scanner:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-domain-http:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-domain-management:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-ee:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-ee-deployment:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-ejb3:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-embedded:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-host-controller:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-jacorb:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-jaxr:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-jaxrs:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-jdr:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-jmx:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-jpa:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-jsf:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-jsr77:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-logging:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-mail:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-management-client-content:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-messaging:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-modcluster:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-naming:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-network:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-osgi:7.3.0-7.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-osgi-configadmin:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-osgi-service:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-platform-mbean:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-pojo:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-process-controller:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-protocol:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-remoting:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-sar:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-security:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-server:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-system-jmx:7.3.0-7.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-threads:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-transactions:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-version:7.3.0-7.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-web:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-webservices:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-weld:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-as-xts:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jboss-dmr:1.2.0-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-ejb-client:1.0.24-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-ejb3-ext-api:2.1.0-1.redhat_1.1.ep6.el6.noarch
#   - jboss-genericjms:1.0.1-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-hal:2.0.6-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-jacc-api_1.4_spec:1.0.3-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-logmanager:1.5.1-1.Final_redhat_1.ep6.el6.noarch
#   - jboss-marshalling:1.4.2-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-modules:1.3.0-2.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-remoting3:3.2.18-1.GA_redhat_1.1.ep6.el6.noarch
#   - jboss-remoting3-jmx:1.1.2-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-security-negotiation:2.2.6-2.Final_redhat_1.2.ep6.el6.noarch
#   - jboss-threads:2.1.1-1.Final_redhat_1.ep6.el6.noarch
#   - jboss-vfs2:3.2.2-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-weld-1.1-api:1.1-8.Final_redhat_4.1.ep6.el6.noarch
#   - jbossas-appclient:7.3.0-8.Final_redhat_14.1.ep6.el6.noarch
#   - jbossas-bundles:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jbossas-core:7.3.0-7.Final_redhat_14.1.ep6.el6.noarch
#   - jbossas-domain:7.3.0-22.Final_redhat_14.1.ep6.el6.noarch
#   - jbossas-modules-eap:7.3.0-21.Final_redhat_14.1.ep6.el6.noarch
#   - jbossas-product-eap:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jbossas-standalone:7.3.0-7.Final_redhat_14.1.ep6.el6.noarch
#   - jbossas-welcome-content-eap:7.3.0-6.Final_redhat_14.1.ep6.el6.noarch
#   - jbossts:4.17.15-4.Final_redhat_4.1.ep6.el6.noarch
#   - jbossws-api:1.0.2-1.Final_redhat_1.2.ep6.el6.noarch
#   - jbossws-common:2.2.3-1.Final_redhat_1.1.ep6.el6.noarch
#   - jbossws-common-tools:1.2.0-2.Final_redhat_2.1.ep6.el6.noarch
#   - jbossws-cxf:4.2.3-1.Final_redhat_1.1.ep6.el6.noarch
#   - jbossws-native:4.1.2-1.Final_redhat_1.1.ep6.el6.noarch
#   - jbossws-spi:2.2.2-1.Final_redhat_1.1.ep6.el6.noarch
#   - jcip-annotations-eap6:1.0-5.redhat_6.1.ep6.el6.noarch
#   - jdom-eap6:1.1.2-5.redhat_3.1.ep6.el6.noarch
#   - jettison:1.3.1-8.redhat_3.1.ep6.el6.noarch
#   - jgroups:3.2.12-1.Final_redhat_1.1.ep6.el6.noarch
#   - juddi:3.1.3-4.redhat_3.1.ep6.el6.noarch
#   - mod_cluster:1.2.6-2.Final_redhat_1.1.ep6.el6.noarch
#   - mod_cluster-demo:1.2.6-2.Final_redhat_1.1.ep6.el6.noarch
#   - objectweb-asm-eap6:3.3.1-6.3.redhat_5.ep6.el6.noarch
#   - opensaml:2.5.3-3.redhat_2.1.ep6.el6.noarch
#   - openws:1.4.4-2.redhat_2.1.ep6.el6.noarch
#   - org.apache.felix.configadmin:1.2.8-7.redhat_4.2.ep6.el6.noarch
#   - org.apache.felix.log:1.0.0-6.redhat_3.1.ep6.el6.noarch
#   - org.osgi.core-eap6:4.2.0-11.10.redhat_4.ep6.el6.noarch
#   - org.osgi.enterprise-eap6:4.2.0-11.10.redhat_4.ep6.el6.noarch
#   - picketbox:4.0.19-1.SP2_redhat_1.1.ep6.el6.noarch
#   - picketlink-federation:2.1.9-3.SP2_redhat_1.1.ep6.el6.noarch
#   - resteasy:2.3.7-2.Final_redhat_2.ep6.el6.noarch
#   - scannotation:1.0.3-2.redhat_4.ep6.el6.noarch
#   - shrinkwrap-api:1.1.2-3.redhat_1.1.ep6.el6.noarch
#   - shrinkwrap-impl-base:1.1.2-3.redhat_1.1.ep6.el6.noarch
#   - shrinkwrap-parent:1.1.2-3.redhat_1.1.ep6.el6.noarch
#   - shrinkwrap-spi:1.1.2-3.redhat_1.1.ep6.el6.noarch
#   - slf4j-eap6:1.7.2-11.redhat_2.1.ep6.el6.noarch
#   - stilts:0.1.26-10.redhat_3.1.ep6.el6.noarch
#   - sun-ws-metadata-2.0-api:1.0.MR1-16_MR1_redhat_6.1.ep6.el6.noarch
#   - velocity-eap6:1.7-4.redhat_3.1.ep6.el6.noarch
#   - weld-cdi-1.0-api:1.0-9.SP4.redhat_3.1.ep6.el6.noarch
#   - weld-core:1.1.16-3.Final_redhat_1.1.ep6.el6.noarch
#   - ws-commons-XmlSchema:2.0.2-8.redhat_3.1.ep6.el6.noarch
#   - ws-commons-neethi:3.0.2-6.redhat_3.1.ep6.el6.noarch
#   - ws-scout:1.2.6-4.redhat_3.1.ep6.el6.noarch
#   - wsdl4j-eap6:1.6.2-14.redhat_6.1.ep6.el6.noarch
#   - wss4j:1.6.12-1.redhat_1.1.ep6.el6.noarch
#   - xerces-j2-eap6:2.9.1-16.redhat_5.1.ep6.el6.noarch
#   - xjc-utils:2.6.1-4.redhat_2.1.ep6.el6.noarch
#   - xml-commons-resolver-eap6:1.2-16.redhat_9.1.ep6.el6.noarch
#   - xml-security:1.5.5-2.redhat_2.1.ep6.el6.noarch
#   - xmltooling:1.3.4-3.redhat_1.1.ep6.el6.noarch
#   - xom:1.2.7-2.redhat_4.1.ep6.el6.noarch
#   - hornetq-native:2.3.8-1.Final_redhat_1.ep6.el6.x86_64
#   - hornetq-native-debuginfo:2.3.8-1.Final_redhat_1.ep6.el6.x86_64
#   - jbossas-hornetq-native:2.3.8-1.Final_redhat_1.ep6.el6.x86_64
#   - mod_cluster-native:1.2.6-1.Final.redhat_1.ep6.el6.x86_64
#   - mod_cluster-native-debuginfo:1.2.6-1.Final.redhat_1.ep6.el6.x86_64
#   - mod_jk-ap22:1.2.37-4.redhat_3.ep6.el6.x86_64
#   - mod_jk-debuginfo:1.2.37-4.redhat_3.ep6.el6.x86_64
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2013:1786
#
