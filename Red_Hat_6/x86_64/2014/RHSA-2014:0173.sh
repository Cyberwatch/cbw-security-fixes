...
#   - mysql55-mysql-bench:5.5.36-1.1.el6.x86_64
#   - mysql55-mysql-debuginfo:5.5.36-1.1.el6.x86_64
#   - mysql55-mysql-devel:5.5.36-1.1.el6.x86_64
#   - mysql55-mysql-libs:5.5.36-1.1.el6.x86_64
#   - mysql55-mysql-server:5.5.36-1.1.el6.x86_64
#   - mysql55-mysql-test:5.5.36-1.1.el6.x86_64
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2014:0173
#
