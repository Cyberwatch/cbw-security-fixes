...
# Script generation date:     2016-01-11 19:14:57 UTC
#
# Operating System: Red Hat 6
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - glassfish-jsf-eap6:2.1.28-2.redhat_3.1.ep6.el6.noarch
#   - glassfish-jsf12-eap6:1.2_15-7.b01_redhat_11.1.ep6.el6.noarch
#   - hibernate4-core-eap6:4.2.7-8.SP4_redhat_1.1.ep6.el6.noarch
#   - hibernate4-eap6:4.2.7-8.SP4_redhat_1.1.ep6.el6.noarch
#   - hibernate4-entitymanager-eap6:4.2.7-8.SP4_redhat_1.1.ep6.el6.noarch
#   - hibernate4-envers-eap6:4.2.7-8.SP4_redhat_1.1.ep6.el6.noarch
#   - hibernate4-infinispan-eap6:4.2.7-8.SP4_redhat_1.1.ep6.el6.noarch
#   - hornetq:2.3.14.1-1.Final_redhat_1.1.ep6.el6.noarch
#   - ironjacamar-common-api-eap6:1.0.23.1-1.Final_redhat_1.1.ep6.el6.noarch
#   - ironjacamar-common-impl-eap6:1.0.23.1-1.Final_redhat_1.1.ep6.el6.noarch
#   - ironjacamar-common-spi-eap6:1.0.23.1-1.Final_redhat_1.1.ep6.el6.noarch
#   - ironjacamar-core-api-eap6:1.0.23.1-1.Final_redhat_1.1.ep6.el6.noarch
#   - ironjacamar-core-impl-eap6:1.0.23.1-1.Final_redhat_1.1.ep6.el6.noarch
#   - ironjacamar-deployers-common-eap6:1.0.23.1-1.Final_redhat_1.1.ep6.el6.noarch
#   - ironjacamar-eap6:1.0.23.1-1.Final_redhat_1.1.ep6.el6.noarch
#   - ironjacamar-jdbc-eap6:1.0.23.1-1.Final_redhat_1.1.ep6.el6.noarch
#   - ironjacamar-spec-api-eap6:1.0.23.1-1.Final_redhat_1.1.ep6.el6.noarch
#   - ironjacamar-validator-eap6:1.0.23.1-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-as-appclient:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-cli:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-client-all:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-clustering:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-cmp:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-configadmin:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-connector:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-controller:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-controller-client:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-core-security:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-deployment-repository:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-deployment-scanner:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-domain-http:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-domain-management:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-ee:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-ee-deployment:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-ejb3:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-embedded:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-host-controller:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-jacorb:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-jaxr:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-jaxrs:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-jdr:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-jmx:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-jpa:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-jsf:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-jsr77:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-logging:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-mail:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-management-client-content:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-messaging:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-modcluster:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-naming:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-network:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-osgi:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-osgi-configadmin:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-osgi-service:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-platform-mbean:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-pojo:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-process-controller:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-protocol:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-remoting:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-sar:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-security:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-server:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-system-jmx:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-threads:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-transactions:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-version:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-web:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-webservices:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-weld:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-as-xts:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jboss-jsf-api_2.1_spec:2.1.28-3.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-jstl-api_1.2_spec:1.0.5-2.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-security-negotiation:2.2.8-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-weld-1.1-api:1.1-9.Final_redhat_5.1.ep6.el6.noarch
#   - jbossas-appclient:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jbossas-bundles:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jbossas-core:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jbossas-domain:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jbossas-javadocs:7.3.3-3.Final_redhat_3.ep6.el6.noarch
#   - jbossas-modules-eap:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jbossas-product-eap:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jbossas-standalone:7.3.3-3.Final_redhat_3.1.ep6.el6.noarch
#   - jbossas-welcome-content-eap:7.3.3-4.Final_redhat_3.1.ep6.el6.noarch
#   - log4j-jboss-logmanager:1.1.0-2.Final_redhat_2.1.ep6.el6.noarch
#   - picketbox:4.0.19-6.SP6_redhat_1.1.ep6.el6.noarch
#   - picketlink-federation:2.1.9-4.SP3_redhat_1.1.ep6.el6.noarch
#   - resteasy:2.3.7.1-1.Final_redhat_1.1.ep6.el6.noarch
#   - weld-cdi-1.0-api:1.0-10.SP4_redhat_4.1.ep6.el6.noarch
#   - weld-core:1.1.17-3.SP2_redhat_1.1.ep6.el6.noarch
#
