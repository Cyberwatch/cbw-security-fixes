...
#   - ror40-rubygem-activerecord.noarch:4.0.2-2.2.el6
#   - ror40-rubygem-activerecord-doc.noarch:4.0.2-2.2.el6
#
# Last versions recommanded by security team:
#   - ror40-rubygem-activerecord.noarch:4.0.2-2.3.el6
#   - ror40-rubygem-activerecord-doc.noarch:4.0.2-2.3.el6
#
# CVE List:
#   - CVE-2014-3483
#
