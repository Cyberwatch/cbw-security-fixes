...
#   - xorg-x11-server-Xephyr:1.15.0-25.el6_6.x86_64
#   - xorg-x11-server-Xorg:1.15.0-25.el6_6.x86_64
#   - xorg-x11-server-common:1.15.0-25.el6_6.x86_64
#   - xorg-x11-server-debuginfo:1.15.0-25.el6_6.x86_64
#   - xorg-x11-server-source:1.15.0-25.el6_6.noarch
#   - xorg-x11-server-Xdmx:1.15.0-25.el6_6.x86_64
#   - xorg-x11-server-Xnest:1.15.0-25.el6_6.x86_64
#   - xorg-x11-server-Xvfb:1.15.0-25.el6_6.x86_64
#   - xorg-x11-server-devel:1.15.0-25.el6_6.x86_64
#
