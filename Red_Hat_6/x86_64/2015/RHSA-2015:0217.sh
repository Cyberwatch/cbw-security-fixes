...
# Script generation date:     2016-01-11 19:16:05 UTC
#
...
#   - apache-cxf:2.7.14-1.redhat_1.1.ep6.el6.noarch
#   - glassfish-jsf-eap6:2.1.28-6.redhat_7.1.ep6.el6.noarch
#   - guava-libraries:13.0.1-4.redhat_2.1.ep6.el6.noarch
#   - hibernate4-core-eap6:4.2.17-2.SP1_redhat_1.1.ep6.el6.noarch
#   - hibernate4-eap6:4.2.17-2.SP1_redhat_1.1.ep6.el6.noarch
#   - hibernate4-entitymanager-eap6:4.2.17-2.SP1_redhat_1.1.ep6.el6.noarch
#   - hibernate4-envers-eap6:4.2.17-2.SP1_redhat_1.1.ep6.el6.noarch
#   - hibernate4-infinispan-eap6:4.2.17-2.SP1_redhat_1.1.ep6.el6.noarch
#   - hornetq:2.3.21.2-1.Final_redhat_1.1.ep6.el6.noarch
#   - httpserver:1.0.2-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-as-appclient:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-cli:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-client-all:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-clustering:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-cmp:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-configadmin:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-connector:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-console:2.2.12-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-as-controller:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-controller-client:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-core-security:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-deployment-repository:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-deployment-scanner:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-domain-http:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-domain-management:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-ee:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-ee-deployment:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-ejb3:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-embedded:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-host-controller:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-jacorb:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-jaxr:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-jaxrs:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-jdr:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-jmx:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-jpa:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-jsf:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-jsr77:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-logging:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-mail:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-management-client-content:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-messaging:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-modcluster:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-naming:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-network:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-osgi:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-osgi-configadmin:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-osgi-service:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-picketlink:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-platform-mbean:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-pojo:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-process-controller:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-protocol:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-remoting:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-sar:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-security:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-server:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-system-jmx:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-threads:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-transactions:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-version:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-web:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-webservices:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-weld:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-as-xts:7.4.3-3.Final_redhat_2.1.ep6.el6.noarch
#   - jboss-ejb-client:1.0.28-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-hal:2.2.12-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-marshalling:1.4.10-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-modules:1.3.5-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-remoting3:3.3.4-1.Final_redhat_1.1.ep6.el6.noarch
#   - jboss-security-negotiation:2.3.6-1.Final_redhat_1.1.ep6.el6.noarch
#   - jbossas-appclient:7.4.3-2.Final_redhat_2.1.ep6.el6.noarch
#   - jbossas-bundles:7.4.3-2.Final_redhat_2.1.ep6.el6.noarch
#   - jbossas-core:7.4.3-2.Final_redhat_2.1.ep6.el6.noarch
#   - jbossas-domain:7.4.3-2.Final_redhat_2.1.ep6.el6.noarch
#   - jbossas-javadocs:7.4.3-2.Final_redhat_2.1.ep6.el6.noarch
#   - jbossas-modules-eap:7.4.3-2.Final_redhat_2.1.ep6.el6.noarch
#   - jbossas-product-eap:7.4.3-2.Final_redhat_2.1.ep6.el6.noarch
#   - jbossas-standalone:7.4.3-2.Final_redhat_2.1.ep6.el6.noarch
#   - jbossas-welcome-content-eap:7.4.3-2.Final_redhat_2.1.ep6.el6.noarch
#   - jbossts:4.17.26-1.Final_redhat_1.1.ep6.el6.noarch
#   - jbossweb:7.4.10-1.Final_redhat_1.1.ep6.el6.noarch
#   - jbossws-cxf:4.3.4-1.Final_redhat_1.1.ep6.el6.noarch
#   - jbossws-spi:2.3.1-1.Final_redhat_1.1.ep6.el6.noarch
#   - picketbox:4.0.19-10.SP10_redhat_1.1.ep6.el6.noarch
#   - picketlink-bindings:2.5.3-15.SP16_redhat_1.1.ep6.el6.noarch
#   - picketlink-federation:2.5.3-16.SP16_redhat_1.1.ep6.el6.noarch
#   - resteasy:2.3.8-13.SP4_redhat_2.1.ep6.el6.noarch
#   - sun-istack-commons:2.6.1-12.redhat_3.1.ep6.el6.noarch
#   - sun-saaj-1.3-impl:1.3.16-11.SP1_redhat_2.1.ep6.el6.noarch
#   - weld-core:1.1.28-1.Final_redhat_1.1.ep6.el6.noarch
