...
#   - libsmbclient:3.6.509-169.6.el6rhs
#   - libsmbclient-devel:3.6.509-169.6.el6rhs
#   - samba:3.6.509-169.6.el6rhs
#   - samba-client:3.6.509-169.6.el6rhs
#   - samba-common:3.6.509-169.6.el6rhs
#   - samba-debuginfo:3.6.509-169.6.el6rhs
#   - samba-doc:3.6.509-169.6.el6rhs
#   - samba-domainjoin-gui:3.6.509-169.6.el6rhs
#   - samba-glusterfs:3.6.509-169.6.el6rhs
#   - samba-swat:3.6.509-169.6.el6rhs
#   - samba-winbind:3.6.509-169.6.el6rhs
#   - samba-winbind-clients:3.6.509-169.6.el6rhs
#   - samba-winbind-devel:3.6.509-169.6.el6rhs
#   - samba-winbind-krb5-locator:3.6.509-169.6.el6rhs
#
...
#   - samba-glusterfs:3.6.9-167.10.3.el6rhs
