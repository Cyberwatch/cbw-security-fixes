...
# Script generation date:     2015-09-10 09:47:52 UTC
#
# Operating System: Red Hat 6
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - httpd24-httpd-manual:2.4.12-4.el6.2
#   - httpd24-httpd:2.4.12-4.el6.2
#   - httpd24-httpd-debuginfo:2.4.12-4.el6.2
#   - httpd24-httpd-devel:2.4.12-4.el6.2
#   - httpd24-httpd-tools:2.4.12-4.el6.2
#   - httpd24-mod_ldap:2.4.12-4.el6.2
#   - httpd24-mod_proxy_html:2.4.12-4.el6.2
#   - httpd24-mod_session:2.4.12-4.el6.2
#   - httpd24-mod_ssl:2.4.12-4.el6.2
#
