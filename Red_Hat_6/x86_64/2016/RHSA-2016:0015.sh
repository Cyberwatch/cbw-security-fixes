...
sudo yum install libwbclient.x86_64-4.1.17 -y 
sudo yum install libwbclient-devel.x86_64-4.1.17 -y 
...
sudo yum install samba-dc.x86_64-4.1.17 -y 
sudo yum install samba-dc-libs.x86_64-4.1.17 -y 
sudo yum install samba-debuginfo.x86_64-4.1.17 -y 
sudo yum install samba-devel.x86_64-4.1.17 -y 
sudo yum install samba-libs.x86_64-4.1.17 -y 
sudo yum install samba-python.x86_64-4.1.17 -y 
sudo yum install samba-test.x86_64-4.1.17 -y 
sudo yum install samba-test-devel.x86_64-4.1.17 -y 
sudo yum install samba-test-libs.x86_64-4.1.17 -y 
sudo yum install samba-vfs-glusterfs.x86_64-4.1.17 -y 
...
sudo yum install samba-winbind-modules.x86_64-4.1.17 -y 
