...
# Script generation date:     2016-03-17 19:15:52 UTC
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2016:0447
#
# Licence: Released under The MIT License (MIT), See LICENSE FILE
sudo yum install ctdb.x86_64-4.2.4 -y 
sudo yum install ctdb-devel.x86_64-4.2.4 -y 
sudo yum install ctdb-tests.x86_64-4.2.4 -y 
sudo yum install libsmbclient.x86_64-3.6.23 -y 
sudo yum install libsmbclient-devel.x86_64-3.6.23 -y 
sudo yum install libwbclient.x86_64-4.2.4 -y 
sudo yum install libwbclient-devel.x86_64-4.2.4 -y 
sudo yum install samba.x86_64-3.6.23 -y 
sudo yum install samba-client.x86_64-3.6.23 -y 
sudo yum install samba-client-libs.x86_64-4.2.4 -y 
sudo yum install samba-common-libs.x86_64-4.2.4 -y 
sudo yum install samba-common-tools.x86_64-4.2.4 -y 
sudo yum install samba-dc.x86_64-4.2.4 -y 
sudo yum install samba-dc-libs.x86_64-4.2.4 -y 
sudo yum install samba-debuginfo.x86_64-3.6.23 -y 
sudo yum install samba-devel.x86_64-4.2.4 -y 
sudo yum install samba-libs.x86_64-4.2.4 -y 
sudo yum install samba-python.x86_64-4.2.4 -y 
sudo yum install samba-test.x86_64-4.2.4 -y 
sudo yum install samba-test-devel.x86_64-4.2.4 -y 
sudo yum install samba-test-libs.x86_64-4.2.4 -y 
sudo yum install samba-vfs-glusterfs.x86_64-4.2.4 -y 
...
sudo yum install samba-winbind-modules.x86_64-4.2.4 -y 
