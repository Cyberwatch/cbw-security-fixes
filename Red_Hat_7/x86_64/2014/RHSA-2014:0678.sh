...
# Script generation date:     2015-09-16 06:11:40 UTC
#
...
#   - kernel-debug-debuginfo:3.10.0-123.1.2.el7
#   - kernel-debug-devel:3.10.0-123.1.2.el7
#   - kernel-debuginfo:3.10.0-123.1.2.el7
#   - kernel-debuginfo-common-x86_64:3.10.0-123.1.2.el7
#   - kernel-devel:3.10.0-123.1.2.el7
#   - kernel-headers:3.10.0-123.1.2.el7
#   - kernel-tools:3.10.0-123.1.2.el7
#   - kernel-tools-debuginfo:3.10.0-123.1.2.el7
#   - kernel-tools-libs:3.10.0-123.1.2.el7
#   - perf:3.10.0-123.1.2.el7
#   - perf-debuginfo:3.10.0-123.1.2.el7
#   - python-perf-debuginfo:3.10.0-123.1.2.el7
