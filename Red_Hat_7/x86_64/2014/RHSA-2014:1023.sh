...
# Script generation date:     2015-11-04 07:13:24 UTC
#
# Operating System: Red Hat 7
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - kernel-abi-whitelists:3.10.0-123.6.3.el7
#   - kernel:3.10.0-123.6.3.el7
#   - kernel-debug:3.10.0-123.6.3.el7
#   - kernel-debug-debuginfo:3.10.0-123.6.3.el7
#   - kernel-debug-devel:3.10.0-123.6.3.el7
#   - kernel-debuginfo:3.10.0-123.6.3.el7
#   - kernel-debuginfo-common-x86_64:3.10.0-123.6.3.el7
#   - kernel-devel:3.10.0-123.6.3.el7
#   - kernel-headers:3.10.0-123.6.3.el7
#   - kernel-tools:3.10.0-123.6.3.el7
#   - kernel-tools-debuginfo:3.10.0-123.6.3.el7
#   - kernel-tools-libs:3.10.0-123.6.3.el7
#   - perf:3.10.0-123.6.3.el7
#   - perf-debuginfo:3.10.0-123.6.3.el7
#   - python-perf-debuginfo:3.10.0-123.6.3.el7
#   - kernel-doc:3.10.0-123.6.3.el7
#   - kernel-tools-libs-devel:3.10.0-123.6.3.el7
#   - python-perf:3.10.0-123.6.3.el7
#
