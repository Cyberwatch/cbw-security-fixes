...
#   - libreoffice-debuginfo.x86_64:4.2.6.3-5.el7
...
sudo yum install autocorr-bg.noarch-4.3.7.2 -y 
sudo yum install autocorr-ca.noarch-4.3.7.2 -y 
sudo yum install autocorr-cs.noarch-4.3.7.2 -y 
sudo yum install autocorr-da.noarch-4.3.7.2 -y 
sudo yum install autocorr-de.noarch-4.3.7.2 -y 
sudo yum install autocorr-en.noarch-4.3.7.2 -y 
sudo yum install autocorr-es.noarch-4.3.7.2 -y 
sudo yum install autocorr-fa.noarch-4.3.7.2 -y 
sudo yum install autocorr-fi.noarch-4.3.7.2 -y 
sudo yum install autocorr-fr.noarch-4.3.7.2 -y 
sudo yum install autocorr-ga.noarch-4.3.7.2 -y 
sudo yum install autocorr-hr.noarch-4.3.7.2 -y 
sudo yum install autocorr-hu.noarch-4.3.7.2 -y 
sudo yum install autocorr-is.noarch-4.3.7.2 -y 
sudo yum install autocorr-it.noarch-4.3.7.2 -y 
sudo yum install autocorr-ja.noarch-4.3.7.2 -y 
sudo yum install autocorr-ko.noarch-4.3.7.2 -y 
sudo yum install autocorr-lb.noarch-4.3.7.2 -y 
sudo yum install autocorr-lt.noarch-4.3.7.2 -y 
sudo yum install autocorr-mn.noarch-4.3.7.2 -y 
sudo yum install autocorr-nl.noarch-4.3.7.2 -y 
sudo yum install autocorr-pl.noarch-4.3.7.2 -y 
sudo yum install autocorr-pt.noarch-4.3.7.2 -y 
sudo yum install autocorr-ro.noarch-4.3.7.2 -y 
sudo yum install autocorr-ru.noarch-4.3.7.2 -y 
sudo yum install autocorr-sk.noarch-4.3.7.2 -y 
sudo yum install autocorr-sl.noarch-4.3.7.2 -y 
sudo yum install autocorr-sr.noarch-4.3.7.2 -y 
sudo yum install autocorr-sv.noarch-4.3.7.2 -y 
sudo yum install autocorr-tr.noarch-4.3.7.2 -y 
sudo yum install autocorr-vi.noarch-4.3.7.2 -y 
sudo yum install autocorr-zh.noarch-4.3.7.2 -y 
sudo yum install libreoffice-opensymbol-fonts.noarch-4.3.7.2 -y 
sudo yum install libabw.x86_64-0.0.2 -y 
sudo yum install libabw-debuginfo.x86_64-0.0.2 -y 
sudo yum install libcmis.x86_64-0.4.1 -y 
sudo yum install libcmis-debuginfo.x86_64-0.4.1 -y 
...
sudo yum install libreoffice-base.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-calc.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-core.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-debuginfo.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-draw.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-emailmerge.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-graphicfilter.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-impress.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-af.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-ar.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-as.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-bg.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-bn.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-br.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-ca.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-cs.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-cy.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-da.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-de.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-dz.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-el.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-en.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-es.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-et.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-eu.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-fa.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-fi.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-fr.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-ga.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-gl.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-gu.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-he.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-hi.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-hr.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-hu.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-it.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-ja.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-kk.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-kn.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-ko.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-lt.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-lv.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-mai.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-ml.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-mr.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-nb.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-nl.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-nn.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-nr.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-nso.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-or.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-pa.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-pl.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-pt-BR.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-pt-PT.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-ro.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-ru.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-si.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-sk.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-sl.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-sr.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-ss.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-st.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-sv.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-ta.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-te.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-th.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-tn.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-tr.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-ts.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-uk.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-ve.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-xh.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-zh-Hans.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-zh-Hant.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-langpack-zu.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-math.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-ogltrans.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-pdfimport.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-pyuno.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-ure.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-wiki-publisher.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-writer.x86_64-4.3.7.2 -y 
...
sudo yum install libcmis-devel.x86_64-0.4.1 -y 
sudo yum install libcmis-tools.x86_64-0.4.1 -y 
...
sudo yum install libreoffice.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-bsh.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-filters.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-gdb-debug-support.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-glade.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-headless.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-librelogo.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-nlpsolver.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-postgresql.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-rhino.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-sdk.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-sdk-doc.x86_64-4.3.7.2 -y 
sudo yum install libreoffice-xsltfilter.x86_64-4.3.7.2 -y 
sudo yum install libabw.i686-0.0.2 -y 
sudo yum install libabw-debuginfo.i686-0.0.2 -y 
sudo yum install libcmis.i686-0.4.1 -y 
sudo yum install libcmis-debuginfo.i686-0.4.1 -y 
...
sudo yum install libcmis-devel.i686-0.4.1 -y 
