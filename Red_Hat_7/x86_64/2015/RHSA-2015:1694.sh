...
#   - gdk-pixbuf2-debuginfo.i686:2.28.2-5.el7_1
#   - gdk-pixbuf2-debuginfo.x86_64:2.28.2-5.el7_1
...
sudo yum install gdk-pixbuf2-debuginfo.i686-2.28.2 -y 
sudo yum install gdk-pixbuf2-debuginfo.x86_64-2.28.2 -y 
