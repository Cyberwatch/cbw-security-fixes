...
#   - openstack-tripleo-puppet-elements:0.0.1-5.el7ost
#   - openstack-tuskar:0.4.18-4.el7ost
#   - openstack-tuskar-ui:0.4.0-3.el7ost
#   - os-cloud-config:0.2.8-7.el7ost
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/RHSA-2015:1862
#
...
sudo yum install openstack-tripleo-image-elements-0.9.6 -y 
sudo yum install openstack-tripleo-puppet-elements-0.0.1 -y 
sudo yum install openstack-tuskar-0.4.18 -y 
sudo yum install openstack-tuskar-ui-0.4.0 -y 
sudo yum install os-cloud-config-0.2.8 -y 
sudo yum install os-net-config-0.1.4 -y 
sudo yum install python-hardware-0.14 -y 
sudo yum install python-hardware-doc-0.14 -y 
sudo yum install python-ironic-discoverd-1.1.0 -y 
sudo yum install python-proliantutils-2.1.0 -y 
