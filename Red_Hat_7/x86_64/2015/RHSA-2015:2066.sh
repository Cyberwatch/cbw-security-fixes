...
# Script generation date:     2016-07-06 21:38:08 UTC
#
...
sudo yum install ceph-common.x86_64-0.94.5 -y 
sudo yum install ceph-debuginfo.x86_64-0.94.5 -y 
sudo yum install ceph-radosgw.x86_64-0.94.5 -y 
sudo yum install libbabeltrace.x86_64-1.2.4 -y 
sudo yum install librados2.x86_64-0.94.5 -y 
sudo yum install librados2-devel.x86_64-0.94.5 -y 
sudo yum install librbd1.x86_64-0.94.5 -y 
sudo yum install librbd1-devel.x86_64-0.94.5 -y 
...
sudo yum install python-rados.x86_64-0.94.5 -y 
sudo yum install python-rbd.x86_64-0.94.5 -y 
sudo yum install calamari-server.x86_64-1.3 -y 
sudo yum install ceph-deploy.noarch-1.5.27.3 -y 
...
sudo yum install ceph.x86_64-0.94.5 -y 
sudo yum install ceph-mon.x86_64-0.94.5 -y 
sudo yum install ceph-test.x86_64-0.94.5 -y 
sudo yum install ceph-osd.x86_64-0.94.5 -y 
