...
sudo yum install ceph-common.x86_64-0.94.3 -y 
sudo yum install ceph-debuginfo.x86_64-0.94.3 -y 
sudo yum install ceph-radosgw.x86_64-0.94.3 -y 
sudo yum install libbabeltrace.x86_64-1.2.4 -y 
sudo yum install librados2.x86_64-0.94.3 -y 
sudo yum install librados2-devel.x86_64-0.94.3 -y 
sudo yum install librbd1.x86_64-0.94.3 -y 
sudo yum install librbd1-devel.x86_64-0.94.3 -y 
...
sudo yum install python-rados.x86_64-0.94.3 -y 
sudo yum install python-rbd.x86_64-0.94.3 -y 
...
sudo yum install ceph.x86_64-0.94.3 -y 
sudo yum install ceph-mon.x86_64-0.94.3 -y 
sudo yum install ceph-test.x86_64-0.94.3 -y 
sudo yum install ceph-osd.x86_64-0.94.3 -y 
