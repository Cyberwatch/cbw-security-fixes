...
# Script generation date:     2016-02-04 19:20:43 UTC
#
...
sudo yum install java-1.8.0-openjdk-accessibility.x86_64-1.8.0.71 -y 
sudo yum install java-1.8.0-openjdk-accessibility-debug.x86_64-1.8.0.71 -y 
