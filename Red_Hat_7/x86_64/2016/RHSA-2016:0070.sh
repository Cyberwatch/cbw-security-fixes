...
#   - openshift-ansible.noarch:3.0.35-1.git.0.6a386dd.el7aos
#   - openshift-ansible-docs.noarch:3.0.35-1.git.0.6a386dd.el7aos
#   - openshift-ansible-filter-plugins.noarch:3.0.35-1.git.0.6a386dd.el7aos
#   - openshift-ansible-lookup-plugins.noarch:3.0.35-1.git.0.6a386dd.el7aos
#   - openshift-ansible-playbooks.noarch:3.0.35-1.git.0.6a386dd.el7aos
#   - openshift-ansible-roles.noarch:3.0.35-1.git.0.6a386dd.el7aos
...
sudo yum install openshift-ansible.noarch-3.0.35 -y 
sudo yum install openshift-ansible-docs.noarch-3.0.35 -y 
sudo yum install openshift-ansible-filter-plugins.noarch-3.0.35 -y 
sudo yum install openshift-ansible-lookup-plugins.noarch-3.0.35 -y 
sudo yum install openshift-ansible-playbooks.noarch-3.0.35 -y 
sudo yum install openshift-ansible-roles.noarch-3.0.35 -y 
...
sudo yum install atomic-openshift.x86_64-3.2.0.20 -y 
sudo yum install atomic-openshift-clients.x86_64-3.2.0.20 -y 
sudo yum install atomic-openshift-clients-redistributable.x86_64-3.2.0.20 -y 
sudo yum install atomic-openshift-dockerregistry.x86_64-3.2.0.20 -y 
sudo yum install atomic-openshift-master.x86_64-3.2.0.20 -y 
sudo yum install atomic-openshift-node.x86_64-3.2.0.20 -y 
sudo yum install atomic-openshift-pod.x86_64-3.2.0.20 -y 
sudo yum install atomic-openshift-recycle.x86_64-3.2.0.20 -y 
sudo yum install atomic-openshift-sdn-ovs.x86_64-3.2.0.20 -y 
...
sudo yum install tuned-profiles-atomic-openshift-node.x86_64-3.2.0.20 -y 
