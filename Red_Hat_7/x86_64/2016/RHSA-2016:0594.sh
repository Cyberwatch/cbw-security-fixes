...
#   - graphite2-debuginfo.i686:1.3.6-1.el7_2
#   - graphite2-debuginfo.x86_64:1.3.6-1.el7_2
...
sudo yum install graphite2-debuginfo.i686-1.3.6 -y 
sudo yum install graphite2-debuginfo.x86_64-1.3.6 -y 
