...
# CYBERWATCH SAS - 2016
#
# Security fix for RHSA-2016:1852
#
# Security announcement date: 2016-09-12 19:14:31 UTC
# Script generation date:     2016-12-08 21:22:21 UTC
#
# Operating System: Red Hat 7
# Architecture: x86_64
#
# Vulnerable packages fix on version:
#   - atomic-openshift.x86_64:3.1.1.7-1.git.0.65f396b.el7aos
#   - atomic-openshift-clients.x86_64:3.1.1.7-1.git.0.65f396b.el7aos
#   - atomic-openshift-clients-redistributable.x86_64:3.1.1.7-1.git.0.65f396b.el7aos
#   - atomic-openshift-dockerregistry.x86_64:3.1.1.7-1.git.0.65f396b.el7aos
#   - atomic-openshift-master.x86_64:3.1.1.7-1.git.0.65f396b.el7aos
#   - atomic-openshift-node.x86_64:3.1.1.7-1.git.0.65f396b.el7aos
#   - atomic-openshift-pod.x86_64:3.1.1.7-1.git.0.65f396b.el7aos
#   - atomic-openshift-recycle.x86_64:3.1.1.7-1.git.0.65f396b.el7aos
#   - atomic-openshift-sdn-ovs.x86_64:3.1.1.7-1.git.0.65f396b.el7aos
#   - tuned-profiles-atomic-openshift-node.x86_64:3.1.1.7-1.git.0.65f396b.el7aos
#
