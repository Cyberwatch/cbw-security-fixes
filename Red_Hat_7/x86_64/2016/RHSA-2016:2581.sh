...
# CYBERWATCH SAS - 2017
#
# Security fix for RHSA-2016:2581
#
# Security announcement date: 2016-11-03 08:55:59 UTC
...
#   - libnl3-debuginfo.i686:3.2.28-2.el7
#   - libnl3-debuginfo.x86_64:3.2.28-2.el7
...
sudo yum install libnl3-debuginfo.i686-3.2.28 -y 
sudo yum install libnl3-debuginfo.x86_64-3.2.28 -y 
