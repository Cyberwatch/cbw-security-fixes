...
#   - python-django-openstack:2012.1.3+stable~20120815-691dd2-0ubuntu1.1
...
sudo apt-get install --only-upgrade python-django-openstack=2012.1.3+stable~20120815-691dd2-0ubuntu1.1 -y
sudo apt-get install --only-upgrade openstack-dashboard-ubuntu-theme=2012.1.3+stable~20120815-691dd2-0ubuntu1.1 -y
sudo apt-get install --only-upgrade python-django-horizon=2012.1.3+stable~20120815-691dd2-0ubuntu1.1 -y
