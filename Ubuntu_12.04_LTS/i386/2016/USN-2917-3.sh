...
# Script generation date:     2016-06-21 01:25:38 UTC
#
...
#   - firefox-locale-gn:47.0+build3-0ubuntu0.12.04.1
...
sudo apt-get install --only-upgrade firefox-locale-gn=47.0+build3-0ubuntu0.12.04.1 -y
