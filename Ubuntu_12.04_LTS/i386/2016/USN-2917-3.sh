...
# Script generation date:     2016-09-22 21:03:57 UTC
#
...
#   - firefox-locale-gn:49.0+build4-0ubuntu0.12.04.1
...
sudo apt-get install --only-upgrade firefox-locale-gn=49.0+build4-0ubuntu0.12.04.1 -y
