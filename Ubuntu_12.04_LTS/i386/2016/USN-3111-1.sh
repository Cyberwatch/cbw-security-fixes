...
# Script generation date:     2016-10-29 21:06:20 UTC
#
...
#   - firefox-locale-cak:49.0.2+build2-0ubuntu0.12.04.1
...
#   - firefox-locale-gn:49.0.2+build2-0ubuntu0.12.04.1
...
sudo apt-get install --only-upgrade firefox-locale-cak=49.0.2+build2-0ubuntu0.12.04.1 -y
...
sudo apt-get install --only-upgrade firefox-locale-gn=49.0.2+build2-0ubuntu0.12.04.1 -y
