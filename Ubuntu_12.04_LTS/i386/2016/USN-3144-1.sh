...
sudo apt-get install --only-upgrade linux-headers-generic-pae=3.2.0.116.132 -y
sudo apt-get install --only-upgrade linux-image-generic-pae=3.2.0.116.132 -y
sudo apt-get install --only-upgrade linux-generic-pae=3.2.0.116.132 -y
sudo apt-get install --only-upgrade linux-backports-modules-headers-precise-generic-pae=3.2.0.116.132 -y
sudo apt-get install --only-upgrade linux-backports-modules-cw-3.3-precise-generic-pae=3.2.0.116.132 -y
