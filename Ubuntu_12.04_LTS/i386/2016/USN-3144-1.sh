...
# Script generation date:     2016-12-06 21:06:00 UTC
#
...
sudo apt-get install --only-upgrade linux-libc-dev=3.2.0-118.161 -y
...
sudo apt-get install --only-upgrade linux-image-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-image=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-crashdump=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-tools=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-image-hwe-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-hwe-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-image-current-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-current-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-headers-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-backports-modules-headers-precise-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-backports-modules-cw-3.3-precise-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-backports-modules-cw-3.4-precise-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-backports-modules-cw-3.5-precise-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-backports-modules-cw-3.6-precise-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-backports-modules-cw-3.7-precise-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-backports-modules-cw-3.8-precise-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-backports-modules-cw-3.10-precise-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-backports-modules-cw-3.11-precise-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-backports-modules-cw-3.12-precise-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-backports-modules-net-precise-generic=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-headers-generic-pae=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-image-generic-pae=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-generic-pae=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-backports-modules-headers-precise-generic-pae=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-backports-modules-cw-3.3-precise-generic-pae=3.2.0.118.133 -y
sudo apt-get install --only-upgrade linux-image-virtual=3.2.0.118.133 -y
