...
#   - linux-headers-generic-pae:3.2.0.121.136
#   - linux-generic-pae:3.2.0.121.136
#   - linux-backports-modules-headers-precise-generic-pae:3.2.0.121.136
#   - linux-backports-modules-cw-3.3-precise-generic-pae:3.2.0.121.136
...
sudo apt-get install --only-upgrade linux-image-generic-pae=3.2.0.121.136 -y
...
sudo apt-get install --only-upgrade linux-headers-generic-pae=3.2.0.121.136 -y
sudo apt-get install --only-upgrade linux-generic-pae=3.2.0.121.136 -y
sudo apt-get install --only-upgrade linux-backports-modules-headers-precise-generic-pae=3.2.0.121.136 -y
sudo apt-get install --only-upgrade linux-backports-modules-cw-3.3-precise-generic-pae=3.2.0.121.136 -y
