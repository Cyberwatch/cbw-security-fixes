...
#   - linux-headers-3.2.0-121-generic-pae:3.2.0-121.164
...
sudo apt-get install --only-upgrade linux-image-3.2.0-121-generic-pae=3.2.0-121.164 -y
sudo apt-get install --only-upgrade linux-headers-3.2.0-121-generic-pae=3.2.0-121.164 -y
