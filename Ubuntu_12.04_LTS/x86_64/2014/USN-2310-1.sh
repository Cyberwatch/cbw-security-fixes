...
# Script generation date:     2016-06-20 13:26:56 UTC
#
...
#   - krb5-multidev:1.10+dfsg~beta1-2ubuntu0.5
#   - libkrb5-dev:1.10+dfsg~beta1-2ubuntu0.5
#   - libkrb5-dbg:1.10+dfsg~beta1-2ubuntu0.5
#   - krb5-pkinit:1.10+dfsg~beta1-2ubuntu0.5
#   - krb5-doc:1.10+dfsg~beta1-2ubuntu0.5
...
#   - krb5-locales:1.10+dfsg~beta1-2ubuntu0.5
#   - libkrb53:1.10+dfsg~beta1-2ubuntu0.5
#   - libk5crypto3:1.10+dfsg~beta1-2ubuntu0.5
#   - krb5-kdc-ldap:1.10+dfsg~beta1-2ubuntu0.5
#   - libkdb5-6:1.10+dfsg~beta1-2ubuntu0.5
#   - krb5-pkinit:1.10+dfsg~beta1-2ubuntu0.5
