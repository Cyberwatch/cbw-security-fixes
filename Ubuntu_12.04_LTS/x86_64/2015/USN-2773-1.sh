...
sudo apt-get install --only-upgrade linux-image-3.2.0-92-virtual=3.2.0-92.130 -y
...
sudo apt-get install --only-upgrade linux-image-3.2.0-92-generic=3.2.0-92.130 -y
