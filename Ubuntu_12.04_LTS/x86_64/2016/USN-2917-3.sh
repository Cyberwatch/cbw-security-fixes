...
# Script generation date:     2016-04-21 06:04:55 UTC
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/USN-2917-3
#
...
sudo apt-get install --only-upgrade firefox-locale-gn=45.0.2+build1-0ubuntu0.12.04.1 -y
