...
#   - linux-cloud-tools-generic-lts-trusty:3.13.0.101.92
#   - linux-generic-lts-trusty:3.13.0.101.92
#   - linux-signed-image-generic-lts-trusty:3.13.0.101.92
#   - linux-signed-generic-lts-trusty:3.13.0.101.92
...
#   - linux-lts-trusty-cloud-tools-3.13.0-101:3.13.0-101.148~precise1
#   - linux-headers-3.13.0-101-generic:3.13.0-101.148~precise1
#   - linux-tools-3.13.0-101-generic:3.13.0-101.148~precise1
#   - linux-cloud-tools-3.13.0-101-generic:3.13.0-101.148~precise1
#
...
sudo apt-get install --only-upgrade linux-cloud-tools-generic-lts-trusty=3.13.0.101.92 -y
sudo apt-get install --only-upgrade linux-generic-lts-trusty=3.13.0.101.92 -y
sudo apt-get install --only-upgrade linux-signed-image-generic-lts-trusty=3.13.0.101.92 -y
sudo apt-get install --only-upgrade linux-signed-generic-lts-trusty=3.13.0.101.92 -y
...
sudo apt-get install --only-upgrade linux-lts-trusty-cloud-tools-3.13.0-101=3.13.0-101.148~precise1 -y
...
sudo apt-get install --only-upgrade linux-cloud-tools-3.13.0-101-generic=3.13.0-101.148~precise1 -y
