...
sudo apt-get install --only-upgrade linux-cloud-tools-generic-lts-trusty=3.13.0.103.94 -y
sudo apt-get install --only-upgrade linux-generic-lts-trusty=3.13.0.103.94 -y
sudo apt-get install --only-upgrade linux-signed-image-generic-lts-trusty=3.13.0.103.94 -y
sudo apt-get install --only-upgrade linux-signed-generic-lts-trusty=3.13.0.103.94 -y
