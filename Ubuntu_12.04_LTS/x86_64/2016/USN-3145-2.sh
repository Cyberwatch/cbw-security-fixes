...
sudo apt-get install --only-upgrade linux-image-generic-lts-trusty=3.13.0.105.96 -y
sudo apt-get install --only-upgrade linux-tools-lts-trusty=3.13.0.105.96 -y
sudo apt-get install --only-upgrade linux-headers-generic-lts-trusty=3.13.0.105.96 -y
sudo apt-get install --only-upgrade linux-tools-generic-lts-trusty=3.13.0.105.96 -y
sudo apt-get install --only-upgrade linux-cloud-tools-generic-lts-trusty=3.13.0.105.96 -y
sudo apt-get install --only-upgrade linux-generic-lts-trusty=3.13.0.105.96 -y
sudo apt-get install --only-upgrade linux-signed-image-generic-lts-trusty=3.13.0.105.96 -y
sudo apt-get install --only-upgrade linux-signed-generic-lts-trusty=3.13.0.105.96 -y
