...
#   - libnss3-dev:2:3.26.2-0ubuntu0.12.04.1
#   - libnss3-dbg:2:3.26.2-0ubuntu0.12.04.1
#
...
sudo apt-get install --only-upgrade libnss3-dev=2:3.26.2-0ubuntu0.12.04.1 -y
sudo apt-get install --only-upgrade libnss3-dbg=2:3.26.2-0ubuntu0.12.04.1 -y
