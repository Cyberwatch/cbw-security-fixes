...
#   - linux-lts-trusty-cloud-tools-3.13.0-108:3.13.0-108.155~precise1
#   - linux-headers-3.13.0-108-generic:3.13.0-108.155~precise1
#   - linux-tools-3.13.0-108-generic:3.13.0-108.155~precise1
#   - linux-cloud-tools-3.13.0-108-generic:3.13.0-108.155~precise1
...
sudo apt-get install --only-upgrade linux-lts-trusty-cloud-tools-3.13.0-108=3.13.0-108.155~precise1 -y
...
sudo apt-get install --only-upgrade linux-cloud-tools-3.13.0-108-generic=3.13.0-108.155~precise1 -y
