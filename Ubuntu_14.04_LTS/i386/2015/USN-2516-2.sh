...
# Script generation date:     2015-09-29 01:29:13 UTC
#
...
sudo apt-get install --only-upgrade linux-tools-common=3.13.0-63.103 -y
sudo apt-get install --only-upgrade linux-doc=3.13.0-63.103 -y
sudo apt-get install --only-upgrade linux-libc-dev=3.13.0-65.105 -y
sudo apt-get install --only-upgrade linux-tools-3.13.0-46-generic=3.13.0-46.79 -y
sudo apt-get install --only-upgrade linux-source-3.13.0=3.13.0-63.103 -y
...
sudo apt-get install --only-upgrade linux-cloud-tools-common=3.13.0-63.103 -y
