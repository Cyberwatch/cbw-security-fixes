...
# Script generation date:     2015-12-16 07:01:40 UTC
#
...
sudo apt-get install --only-upgrade linux-tools-common=3.13.0-71.114 -y
...
sudo apt-get install --only-upgrade linux-doc=3.13.0-71.114 -y
...
sudo apt-get install --only-upgrade linux-source-3.13.0=3.13.0-71.114 -y
...
sudo apt-get install --only-upgrade linux-cloud-tools-common=3.13.0-71.114 -y
