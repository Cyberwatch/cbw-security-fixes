...
# Script generation date:     2016-03-14 07:01:46 UTC
#
...
sudo apt-get install --only-upgrade linux-tools-common=3.13.0-77.121 -y
...
sudo apt-get install --only-upgrade linux-doc=3.13.0-77.121 -y
...
sudo apt-get install --only-upgrade linux-libc-dev=3.13.0-79.123 -y
...
sudo apt-get install --only-upgrade linux-source-3.13.0=3.13.0-77.121 -y
...
sudo apt-get install --only-upgrade linux-cloud-tools-common=3.13.0-77.121 -y
