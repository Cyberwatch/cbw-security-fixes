...
# Script generation date:     2016-01-22 19:01:51 UTC
#
...
sudo apt-get install --only-upgrade linux-tools-common=3.13.0-76.120 -y
...
sudo apt-get install --only-upgrade linux-doc=3.13.0-76.120 -y
...
sudo apt-get install --only-upgrade linux-source-3.13.0=3.13.0-76.120 -y
...
sudo apt-get install --only-upgrade linux-cloud-tools-common=3.13.0-76.120 -y
