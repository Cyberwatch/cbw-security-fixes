...
sudo apt-get install --only-upgrade libpcrecpp0=1:8.31-2ubuntu2.1 -y
sudo apt-get install --only-upgrade libpcre3-dev=1:8.31-2ubuntu2.1 -y
sudo apt-get install --only-upgrade libpcre3-dbg=1:8.31-2ubuntu2.1 -y
