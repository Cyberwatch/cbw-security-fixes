...
# CYBERWATCH SAS - 2016
#
# Security fix for USN-2909-2
#
# Security announcement date: 2016-02-27 00:00:00 UTC
# Script generation date:     2016-02-29 07:03:14 UTC
#
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/USN-2909-2
#
# Licence: Released under The MIT License (MIT), See LICENSE FILE
sudo apt-get install --only-upgrade linux-image-3.16.0-62-generic-lpae=3.16.0-62.83~14.04.1 -y
sudo apt-get install --only-upgrade linux-image-3.16.0-62-lowlatency=3.16.0-62.83~14.04.1 -y
sudo apt-get install --only-upgrade linux-image-3.16.0-62-powerpc-e500mc=3.16.0-62.83~14.04.1 -y
sudo apt-get install --only-upgrade linux-image-3.16.0-62-powerpc64-emb=3.16.0-62.83~14.04.1 -y
sudo apt-get install --only-upgrade linux-image-3.16.0-62-powerpc64-smp=3.16.0-62.83~14.04.1 -y
sudo apt-get install --only-upgrade linux-image-3.16.0-62-generic=3.16.0-62.83~14.04.1 -y
sudo apt-get install --only-upgrade linux-image-3.16.0-62-powerpc-smp=3.16.0-62.83~14.04.1 -y
