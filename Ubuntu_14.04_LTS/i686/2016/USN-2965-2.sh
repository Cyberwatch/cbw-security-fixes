...
sudo apt-get install --only-upgrade linux-image-4.4.0-22-lowlatency=4.4.0-22.39~14.04.1 -y
sudo apt-get install --only-upgrade linux-image-4.4.0-22-generic=4.4.0-22.39~14.04.1 -y
