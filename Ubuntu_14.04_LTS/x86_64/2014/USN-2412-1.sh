...
#   - ruby2.0-doc:2.0.0.484-1ubuntu2.2
...
sudo apt-get install --only-upgrade ruby2.0-dev=2.0.0.484-1ubuntu2.2 -y
sudo apt-get install --only-upgrade ruby2.0-doc=2.0.0.484-1ubuntu2.2 -y
...
sudo apt-get install --only-upgrade libruby1.9.1-dbg=1.9.3.484-2ubuntu1.2 -y
sudo apt-get install --only-upgrade ruby1.9.1-dev=1.9.3.484-2ubuntu1.2 -y
sudo apt-get install --only-upgrade ruby1.9.1-examples=1.9.3.484-2ubuntu1.2 -y
sudo apt-get install --only-upgrade libruby1.9.1=1.9.3.484-2ubuntu1.2 -y
sudo apt-get install --only-upgrade ruby2.0=2.0.0.484-1ubuntu2.2 -y
