...
# Script generation date:     2015-10-01 19:40:31 UTC
#
...
sudo apt-get install --only-upgrade linux-tools-common=3.13.0-65.105 -y
sudo apt-get install --only-upgrade linux-doc=3.13.0-65.105 -y
...
sudo apt-get install --only-upgrade linux-source-3.13.0=3.13.0-65.105 -y
...
sudo apt-get install --only-upgrade linux-cloud-tools-common=3.13.0-65.105 -y
