...
# Script generation date:     2015-09-10 10:18:01 UTC
#
...
sudo apt-get install --only-upgrade linux-tools-common=3.13.0-62.102 -y
sudo apt-get install --only-upgrade linux-doc=3.13.0-62.102 -y
...
sudo apt-get install --only-upgrade linux-source-3.13.0=3.13.0-62.102 -y
...
sudo apt-get install --only-upgrade linux-cloud-tools-common=3.13.0-62.102 -y
