...
sudo apt-get install --only-upgrade linux-image-3.13.0-65-generic=3.13.0-65.105 -y
...
sudo apt-get install --only-upgrade linux-image-3.13.0-65-lowlatency=3.13.0-65.105 -y
