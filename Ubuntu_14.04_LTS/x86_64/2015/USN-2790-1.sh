...
sudo apt-get install --only-upgrade libnspr4-dev=2:4.10.10-0ubuntu0.14.04.1 -y
sudo apt-get install --only-upgrade libnspr4-dbg=2:4.10.10-0ubuntu0.14.04.1 -y
