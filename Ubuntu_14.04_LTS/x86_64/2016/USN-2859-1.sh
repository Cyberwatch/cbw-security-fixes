...
# Script generation date:     2016-07-18 21:07:25 UTC
#
...
#   - thunderbird-locale-cy:1:45.2.0+build1-0ubuntu0.14.04.3
...
sudo apt-get install --only-upgrade thunderbird-locale-cy=1:45.2.0+build1-0ubuntu0.14.04.3 -y
