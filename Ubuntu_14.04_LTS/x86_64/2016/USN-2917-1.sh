...
# Script generation date:     2016-04-08 06:04:33 UTC
#
...
#   - firefox-locale-gn:45.0+build2-0ubuntu0.14.04.1
...
#   - firefox-locale-gn:45.0.1+build1-0ubuntu0.14.04.2
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/USN-2917-1
#
...
sudo apt-get install --only-upgrade firefox-locale-gn=45.0.1+build1-0ubuntu0.14.04.2 -y
