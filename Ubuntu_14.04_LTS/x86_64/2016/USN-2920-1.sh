...
#   - liboxideqtcore-dev:1.15.8-0ubuntu0.14.04.1
#   - liboxideqtquick0:1.15.8-0ubuntu0.14.04.1
#   - liboxideqtquick-dev:1.15.8-0ubuntu0.14.04.1
...
sudo apt-get install --only-upgrade liboxideqtcore-dev=1.15.8-0ubuntu0.14.04.1 -y
sudo apt-get install --only-upgrade liboxideqtquick0=1.15.8-0ubuntu0.14.04.1 -y
sudo apt-get install --only-upgrade liboxideqtquick-dev=1.15.8-0ubuntu0.14.04.1 -y
