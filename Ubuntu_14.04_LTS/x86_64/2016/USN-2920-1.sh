...
#
# More details:
#   - https://www.cyberwatch.fr/notices/USN-2920-1
#
# Licence: Released under The MIT License (MIT), See LICENSE FILE
sudo apt-get install --only-upgrade liboxideqtcore0=1.13.6-0ubuntu0.14.04.1 -y
sudo apt-get install --only-upgrade liboxideqtcore-dev=1.13.6-0ubuntu0.14.04.1 -y
sudo apt-get install --only-upgrade liboxideqtquick0=1.13.6-0ubuntu0.14.04.1 -y
sudo apt-get install --only-upgrade liboxideqtquick-dev=1.13.6-0ubuntu0.14.04.1 -y
