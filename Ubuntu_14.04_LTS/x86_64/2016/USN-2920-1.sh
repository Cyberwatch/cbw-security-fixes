...
# Script generation date:     2016-10-22 21:03:36 UTC
#
...
#   - liboxideqtcore-dev:1.17.9-0ubuntu0.14.04.1
#   - liboxideqtquick0:1.17.9-0ubuntu0.14.04.1
#   - liboxideqtquick-dev:1.17.9-0ubuntu0.14.04.1
...
sudo apt-get install --only-upgrade liboxideqtcore-dev=1.17.9-0ubuntu0.14.04.1 -y
sudo apt-get install --only-upgrade liboxideqtquick0=1.17.9-0ubuntu0.14.04.1 -y
sudo apt-get install --only-upgrade liboxideqtquick-dev=1.17.9-0ubuntu0.14.04.1 -y
