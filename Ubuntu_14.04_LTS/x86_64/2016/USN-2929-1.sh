...
# Script generation date:     2016-04-05 18:04:31 UTC
#
...
#   - linux-cloud-tools-3.13.0-83:3.13.0-83.127
...
#   - linux-cloud-tools-3.13.0-83-generic:3.13.0-83.127
#   - linux-headers-3.13.0-83-lowlatency:3.13.0-83.127
#   - linux-tools-3.13.0-83-lowlatency:3.13.0-83.127
#   - linux-cloud-tools-3.13.0-83-lowlatency:3.13.0-83.127
...
#
# More details:
#   - https://www.cyberwatch.fr/notices/USN-2929-1
#
...
sudo apt-get install --only-upgrade linux-cloud-tools-3.13.0-83=3.13.0-83.127 -y
...
sudo apt-get install --only-upgrade linux-cloud-tools-3.13.0-83-generic=3.13.0-83.127 -y
...
sudo apt-get install --only-upgrade linux-cloud-tools-3.13.0-83-lowlatency=3.13.0-83.127 -y
