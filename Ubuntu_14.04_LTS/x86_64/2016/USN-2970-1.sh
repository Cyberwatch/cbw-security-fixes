...
sudo apt-get install --only-upgrade linux-image-3.19.0-59-lowlatency=3.19.0-59.65~14.04.1 -y
sudo apt-get install --only-upgrade linux-image-3.19.0-59-generic=3.19.0-59.65~14.04.1 -y
