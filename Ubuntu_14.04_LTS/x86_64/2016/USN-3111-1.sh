...
# Script generation date:     2016-11-19 21:04:18 UTC
#
...
sudo apt-get install --only-upgrade firefox-locale-cak=50.0+build2-0ubuntu0.14.04.2 -y
...
sudo apt-get install --only-upgrade firefox-locale-gn=50.0+build2-0ubuntu0.14.04.2 -y
