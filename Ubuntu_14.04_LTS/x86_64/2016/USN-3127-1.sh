...
# Script generation date:     2016-11-30 21:03:45 UTC
#
...
#   - linux-image-virtual:3.13.0.103.111
#
# CVE List:
#   - CVE-2014-9904
#   - CVE-2015-3288
...
sudo apt-get install --only-upgrade linux-image-virtual=3.13.0.103.111 -y
