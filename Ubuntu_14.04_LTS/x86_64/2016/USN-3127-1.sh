...
#   - linux-generic-lts-quantal-eol-upgrade:3.13.0.101.109
#   - linux-signed-image-generic-lts-quantal:3.13.0.101.109
#   - linux-signed-generic-lts-quantal:3.13.0.101.109
#   - linux-signed-generic-lts-quantal-eol-upgrade:3.13.0.101.109
...
#   - linux-generic-lts-raring-eol-upgrade:3.13.0.101.109
#   - linux-signed-image-generic-lts-raring:3.13.0.101.109
#   - linux-signed-generic-lts-raring:3.13.0.101.109
#   - linux-signed-generic-lts-raring-eol-upgrade:3.13.0.101.109
...
#   - linux-cloud-tools-3.13.0-101:3.13.0-101.148
...
#   - linux-cloud-tools-3.13.0-101-generic:3.13.0-101.148
#   - linux-headers-3.13.0-101-lowlatency:3.13.0-101.148
#   - linux-tools-3.13.0-101-lowlatency:3.13.0-101.148
#   - linux-cloud-tools-3.13.0-101-lowlatency:3.13.0-101.148
...
sudo apt-get install --only-upgrade linux-generic-lts-quantal-eol-upgrade=3.13.0.101.109 -y
sudo apt-get install --only-upgrade linux-signed-image-generic-lts-quantal=3.13.0.101.109 -y
sudo apt-get install --only-upgrade linux-signed-generic-lts-quantal=3.13.0.101.109 -y
sudo apt-get install --only-upgrade linux-signed-generic-lts-quantal-eol-upgrade=3.13.0.101.109 -y
...
sudo apt-get install --only-upgrade linux-generic-lts-raring-eol-upgrade=3.13.0.101.109 -y
sudo apt-get install --only-upgrade linux-signed-image-generic-lts-raring=3.13.0.101.109 -y
sudo apt-get install --only-upgrade linux-signed-generic-lts-raring=3.13.0.101.109 -y
sudo apt-get install --only-upgrade linux-signed-generic-lts-raring-eol-upgrade=3.13.0.101.109 -y
...
sudo apt-get install --only-upgrade linux-cloud-tools-3.13.0-101=3.13.0-101.148 -y
...
sudo apt-get install --only-upgrade linux-cloud-tools-3.13.0-101-generic=3.13.0-101.148 -y
...
sudo apt-get install --only-upgrade linux-cloud-tools-3.13.0-101-lowlatency=3.13.0-101.148 -y
