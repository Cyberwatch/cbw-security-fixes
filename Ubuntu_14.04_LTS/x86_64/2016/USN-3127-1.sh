...
# Script generation date:     2017-02-02 21:04:18 UTC
#
...
#   - linux-image-virtual:3.13.0.108.116
#
# CVE List:
#   - CVE-2014-9904
#   - CVE-2015-3288
...
sudo apt-get install --only-upgrade linux-image-virtual=3.13.0.108.116 -y
