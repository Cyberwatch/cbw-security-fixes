...
# Script generation date:     2016-12-19 21:06:39 UTC
#
...
#   - linux-image-virtual:3.13.0.106.114
#
# CVE List:
#   - CVE-2014-9904
#   - CVE-2015-3288
...
sudo apt-get install --only-upgrade linux-image-virtual=3.13.0.106.114 -y
