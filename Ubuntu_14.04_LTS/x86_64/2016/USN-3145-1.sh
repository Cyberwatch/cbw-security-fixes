...
sudo apt-get install --only-upgrade linux-image-generic=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-crashdump=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-image-hwe-generic-trusty=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-hwe-generic-trusty=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-image-hwe-virtual-trusty=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-hwe-virtual-trusty=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-tools-lts-quantal=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-headers-generic-lts-quantal=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-image-generic-lts-quantal=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-generic-lts-quantal=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-generic-lts-quantal-eol-upgrade=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-signed-image-generic-lts-quantal=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-signed-generic-lts-quantal=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-signed-generic-lts-quantal-eol-upgrade=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-tools-lts-raring=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-headers-generic-lts-raring=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-image-generic-lts-raring=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-generic-lts-raring=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-generic-lts-raring-eol-upgrade=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-signed-image-generic-lts-raring=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-signed-generic-lts-raring=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-signed-generic-lts-raring-eol-upgrade=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-tools-lts-saucy=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-headers-generic-lts-saucy=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-image-generic-lts-saucy=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-tools-generic-lts-saucy=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-generic-lts-saucy=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-generic-lts-saucy-eol-upgrade=3.13.0.103.111 -y
sudo apt-get install --only-upgrade linux-image-lowlatency=3.13.0.103.111 -y
