...
sudo apt-get install --only-upgrade linux-headers-generic-lts-xenial=4.4.0.51.38 -y
sudo apt-get install --only-upgrade linux-image-generic-lts-xenial=4.4.0.51.38 -y
sudo apt-get install --only-upgrade linux-tools-generic-lts-xenial=4.4.0.51.38 -y
sudo apt-get install --only-upgrade linux-cloud-tools-generic-lts-xenial=4.4.0.51.38 -y
sudo apt-get install --only-upgrade linux-generic-lts-xenial=4.4.0.51.38 -y
sudo apt-get install --only-upgrade linux-headers-lowlatency-lts-xenial=4.4.0.51.38 -y
sudo apt-get install --only-upgrade linux-tools-lowlatency-lts-xenial=4.4.0.51.38 -y
sudo apt-get install --only-upgrade linux-cloud-tools-lowlatency-lts-xenial=4.4.0.51.38 -y
sudo apt-get install --only-upgrade linux-lowlatency-lts-xenial=4.4.0.51.38 -y
sudo apt-get install --only-upgrade linux-image-virtual-lts-xenial=4.4.0.51.38 -y
