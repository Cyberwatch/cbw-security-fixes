...
sudo apt-get install --only-upgrade liboxideqtcore0=1.3.4-0ubuntu0.14.10.1 -y
sudo apt-get install --only-upgrade oxideqt-codecs=1.3.4-0ubuntu0.14.10.1 -y
sudo apt-get install --only-upgrade oxideqt-codecs-extra=1.3.4-0ubuntu0.14.10.1 -y
