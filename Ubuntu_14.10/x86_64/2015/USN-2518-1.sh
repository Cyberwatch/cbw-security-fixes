...
sudo apt-get install --only-upgrade linux-image-3.16.0-31-generic=3.16.0-31.41 -y
...
sudo apt-get install --only-upgrade linux-image-3.16.0-31-lowlatency=3.16.0-31.41 -y
