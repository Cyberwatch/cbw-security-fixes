...
sudo apt-get install --only-upgrade linux-image-3.16.0-34-lowlatency=3.16.0-34.45 -y
sudo apt-get install --only-upgrade linux-image-3.16.0-34-generic=3.16.0-34.45 -y
