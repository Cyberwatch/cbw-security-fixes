...
#   - oxideqt-codecs:1.9.1-0ubuntu0.15.04.1
#   - oxideqt-codecs-extra:1.9.1-0ubuntu0.15.04.1
#
# CVE List:
#   - CVE-2015-1253
#   - CVE-2015-1254
...
sudo apt-get install --only-upgrade liboxideqtcore0=1.9.1-0ubuntu0.15.04.1 -y
sudo apt-get install --only-upgrade oxideqt-codecs=1.9.1-0ubuntu0.15.04.1 -y
sudo apt-get install --only-upgrade oxideqt-codecs-extra=1.9.1-0ubuntu0.15.04.1 -y
