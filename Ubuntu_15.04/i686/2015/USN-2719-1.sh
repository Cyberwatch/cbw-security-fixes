...
sudo apt-get install --only-upgrade linux-image-3.19.0-26-generic-lpae=3.19.0-26.28 -y
...
sudo apt-get install --only-upgrade linux-image-3.19.0-26-powerpc64-emb=3.19.0-26.28 -y
sudo apt-get install --only-upgrade linux-image-3.19.0-26-powerpc-smp=3.19.0-26.28 -y
sudo apt-get install --only-upgrade linux-image-3.19.0-26-powerpc64-smp=3.19.0-26.28 -y
sudo apt-get install --only-upgrade linux-image-3.19.0-26-powerpc-e500mc=3.19.0-26.28 -y
