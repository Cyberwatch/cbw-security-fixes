...
#
# More details:
#   - https://www.cyberwatch.fr/notices/USN-2752-1
#
# Licence: Released under The MIT License (MIT), See LICENSE FILE
sudo apt-get install --only-upgrade linux-image-3.19.0-30-powerpc64-smp=3.19.0-30.33 -y
sudo apt-get install --only-upgrade linux-image-3.19.0-30-generic=3.19.0-30.33 -y
...
sudo apt-get install --only-upgrade linux-image-3.19.0-30-lowlatency=3.19.0-30.33 -y
