...
# Script generation date:     2016-05-26 13:51:04 UTC
#
...
#   - samba-libs:2:4.1.17+dfsg-4ubuntu3.1
#   - samba-common:2:4.1.17+dfsg-4ubuntu3.1
#   - samba-common-bin:2:4.1.17+dfsg-4ubuntu3.1
#   - smbclient:2:4.1.17+dfsg-4ubuntu3.1
#   - libparse-pidl-perl:2:4.1.17+dfsg-4ubuntu3.1
#   - samba-dev:2:4.1.17+dfsg-4ubuntu3.1
#   - samba-doc:2:4.1.17+dfsg-4ubuntu3.1
#   - python-samba:2:4.1.17+dfsg-4ubuntu3.1
#   - samba-dsdb-modules:2:4.1.17+dfsg-4ubuntu3.1
#   - samba-vfs-modules:2:4.1.17+dfsg-4ubuntu3.1
#   - libpam-smbpass:2:4.1.17+dfsg-4ubuntu3.1
#   - libsmbclient:2:4.1.17+dfsg-4ubuntu3.1
#   - libsmbclient-dev:2:4.1.17+dfsg-4ubuntu3.1
#   - libsmbsharemodes0:2:4.1.17+dfsg-4ubuntu3.1
#   - libsmbsharemodes-dev:2:4.1.17+dfsg-4ubuntu3.1
#   - winbind:2:4.1.17+dfsg-4ubuntu3.1
#   - samba-dbg:2:4.1.17+dfsg-4ubuntu3.1
#   - libwbclient0:2:4.1.17+dfsg-4ubuntu3.1
