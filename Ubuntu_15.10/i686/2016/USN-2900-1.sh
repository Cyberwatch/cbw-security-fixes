...
#   - libc6-amd64:2.21-0ubuntu4.3
#   - libc6-dev-amd64:2.21-0ubuntu4.3
...
sudo apt-get install --only-upgrade libc6-amd64=2.21-0ubuntu4.3 -y
sudo apt-get install --only-upgrade libc6-dev-amd64=2.21-0ubuntu4.3 -y
