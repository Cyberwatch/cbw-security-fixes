...
# Script generation date:     2016-05-19 06:03:55 UTC
#
...
#   - firefox-locale-gn:46.0.1+build1-0ubuntu0.15.10.2
...
sudo apt-get install --only-upgrade firefox-locale-gn=46.0.1+build1-0ubuntu0.15.10.2 -y
