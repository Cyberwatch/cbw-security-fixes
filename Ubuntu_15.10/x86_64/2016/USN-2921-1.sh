...
# Script generation date:     2016-06-10 06:03:56 UTC
#
...
#   - squid3-dbg:3.3.8-1ubuntu16.3
#   - squid3-common:3.3.8-1ubuntu16.3
#
# CVE List:
#   - CVE-2014-6270
#   - CVE-2016-2571
...
sudo apt-get install --only-upgrade squid3-dbg=3.3.8-1ubuntu16.3 -y
sudo apt-get install --only-upgrade squid3-common=3.3.8-1ubuntu16.3 -y
