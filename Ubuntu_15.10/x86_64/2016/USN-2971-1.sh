...
sudo apt-get install --only-upgrade linux-image-4.2.0-36-lowlatency=4.2.0-36.41 -y
sudo apt-get install --only-upgrade linux-image-4.2.0-36-generic=4.2.0-36.41 -y
