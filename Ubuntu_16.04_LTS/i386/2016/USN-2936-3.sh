...
# Script generation date:     2016-10-28 21:05:58 UTC
#
...
#   - firefox-locale-km:49.0.2+build2-0ubuntu0.16.04.2
#
# CVE List:
#   - CVE-2016-2804
#   - CVE-2016-2806
...
sudo apt-get install --only-upgrade firefox-locale-km=49.0.2+build2-0ubuntu0.16.04.2 -y
