...
#   - imagemagick-doc:8:6.8.9.9-7ubuntu5.2
...
#   - libmagickcore-6.q16-dev:8:6.8.9.9-7ubuntu5.2
#   - libmagickwand-6.q16-2:8:6.8.9.9-7ubuntu5.2
#   - libmagickwand-6.q16-dev:8:6.8.9.9-7ubuntu5.2
#   - libmagick++-6.q16-dev:8:6.8.9.9-7ubuntu5.2
#   - imagemagick-dbg:8:6.8.9.9-7ubuntu5.2
...
#   - libmagick++-dev:8:6.8.9.9-7ubuntu5.2
#
# CVE List:
#   - CVE-2016-3714
#   - CVE-2016-3715
...
sudo apt-get install --only-upgrade imagemagick-common=8:6.8.9.9-7ubuntu5.2 -y
sudo apt-get install --only-upgrade imagemagick-doc=8:6.8.9.9-7ubuntu5.2 -y
sudo apt-get install --only-upgrade libmagickcore-6-headers=8:6.8.9.9-7ubuntu5.2 -y
sudo apt-get install --only-upgrade libmagickwand-6-headers=8:6.8.9.9-7ubuntu5.2 -y
sudo apt-get install --only-upgrade libmagick++-6-headers=8:6.8.9.9-7ubuntu5.2 -y
sudo apt-get install --only-upgrade imagemagick=8:6.8.9.9-7ubuntu5.2 -y
sudo apt-get install --only-upgrade libimage-magick-perl=8:6.8.9.9-7ubuntu5.2 -y
sudo apt-get install --only-upgrade libmagickcore-6-arch-config=8:6.8.9.9-7ubuntu5.2 -y
...
sudo apt-get install --only-upgrade libmagickcore-6.q16-dev=8:6.8.9.9-7ubuntu5.2 -y
sudo apt-get install --only-upgrade libmagickwand-6.q16-2=8:6.8.9.9-7ubuntu5.2 -y
sudo apt-get install --only-upgrade libmagickwand-6.q16-dev=8:6.8.9.9-7ubuntu5.2 -y
sudo apt-get install --only-upgrade libmagick++-6.q16-dev=8:6.8.9.9-7ubuntu5.2 -y
sudo apt-get install --only-upgrade imagemagick-dbg=8:6.8.9.9-7ubuntu5.2 -y
sudo apt-get install --only-upgrade libimage-magick-q16-perl=8:6.8.9.9-7ubuntu5.2 -y
sudo apt-get install --only-upgrade libmagickcore-dev=8:6.8.9.9-7ubuntu5.2 -y
sudo apt-get install --only-upgrade libmagickwand-dev=8:6.8.9.9-7ubuntu5.2 -y
sudo apt-get install --only-upgrade libmagick++-dev=8:6.8.9.9-7ubuntu5.2 -y
