...
sudo apt-get install --only-upgrade qemu-system-s390x=1:2.5+dfsg-5ubuntu10.6 -y
sudo apt-get install --only-upgrade qemu-system=1:2.5+dfsg-5ubuntu10.6 -y
sudo apt-get install --only-upgrade qemu-system-aarch64=1:2.5+dfsg-5ubuntu10.6 -y
