...
sudo apt-get install --only-upgrade libnss3-1d=2:3.26.2-0ubuntu0.16.04.2 -y
sudo apt-get install --only-upgrade libnss3-nssdb=2:3.26.2-0ubuntu0.16.04.2 -y
sudo apt-get install --only-upgrade libnss3-dev=2:3.26.2-0ubuntu0.16.04.2 -y
sudo apt-get install --only-upgrade libnss3-dbg=2:3.26.2-0ubuntu0.16.04.2 -y
