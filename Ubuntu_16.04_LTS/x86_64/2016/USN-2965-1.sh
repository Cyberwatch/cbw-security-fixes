...
sudo apt-get install --only-upgrade linux-image-4.4.0-22-lowlatency=4.4.0-22.39 -y
sudo apt-get install --only-upgrade linux-source-4.4.0=4.4.0-22.39 -y
sudo apt-get install --only-upgrade linux-doc=4.4.0-22.39 -y
sudo apt-get install --only-upgrade linux-headers-4.4.0-22=4.4.0-22.39 -y
sudo apt-get install --only-upgrade linux-libc-dev=4.4.0-22.39 -y
sudo apt-get install --only-upgrade linux-tools-common=4.4.0-22.39 -y
sudo apt-get install --only-upgrade linux-tools-4.4.0-22=4.4.0-22.39 -y
sudo apt-get install --only-upgrade linux-cloud-tools-common=4.4.0-22.39 -y
sudo apt-get install --only-upgrade linux-cloud-tools-4.4.0-22=4.4.0-22.39 -y
sudo apt-get install --only-upgrade linux-image-4.4.0-22-generic=4.4.0-22.39 -y
sudo apt-get install --only-upgrade linux-image-extra-4.4.0-22-generic=4.4.0-22.39 -y
sudo apt-get install --only-upgrade linux-headers-4.4.0-22-generic=4.4.0-22.39 -y
sudo apt-get install --only-upgrade linux-tools-4.4.0-22-generic=4.4.0-22.39 -y
sudo apt-get install --only-upgrade linux-cloud-tools-4.4.0-22-generic=4.4.0-22.39 -y
sudo apt-get install --only-upgrade linux-headers-4.4.0-22-lowlatency=4.4.0-22.39 -y
sudo apt-get install --only-upgrade linux-tools-4.4.0-22-lowlatency=4.4.0-22.39 -y
sudo apt-get install --only-upgrade linux-cloud-tools-4.4.0-22-lowlatency=4.4.0-22.39 -y
