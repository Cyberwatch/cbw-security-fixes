...
sudo apt-get install --only-upgrade linux-source-4.4.0=4.4.0-22.40 -y
sudo apt-get install --only-upgrade linux-doc=4.4.0-22.40 -y
sudo apt-get install --only-upgrade linux-headers-4.4.0-22=4.4.0-22.40 -y
sudo apt-get install --only-upgrade linux-libc-dev=4.4.0-22.40 -y
sudo apt-get install --only-upgrade linux-tools-common=4.4.0-22.40 -y
sudo apt-get install --only-upgrade linux-tools-4.4.0-22=4.4.0-22.40 -y
sudo apt-get install --only-upgrade linux-cloud-tools-common=4.4.0-22.40 -y
