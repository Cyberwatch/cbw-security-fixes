...
sudo apt-get install --only-upgrade quagga=0.99.24.1-2ubuntu1.1 -y
sudo apt-get install --only-upgrade quagga-dbg=0.99.24.1-2ubuntu1.1 -y
sudo apt-get install --only-upgrade quagga-doc=0.99.24.1-2ubuntu1.1 -y
