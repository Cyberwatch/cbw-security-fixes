...
# Script generation date:     2017-01-13 21:05:51 UTC
#
...
#   - linux-signed-image-generic:4.4.0.59.62
#   - linux-signed-generic:4.4.0.59.62
#   - linux-signed-image-lowlatency:4.4.0.59.62
#   - linux-signed-lowlatency:4.4.0.59.62
...
sudo apt-get install --only-upgrade linux-source-4.4.0=4.4.0-59.80 -y
sudo apt-get install --only-upgrade linux-doc=4.4.0-59.80 -y
sudo apt-get install --only-upgrade linux-headers-4.4.0-59=4.4.0-59.80 -y
sudo apt-get install --only-upgrade linux-libc-dev=4.4.0-59.80 -y
sudo apt-get install --only-upgrade linux-tools-common=4.4.0-59.80 -y
sudo apt-get install --only-upgrade linux-tools-4.4.0-59=4.4.0-59.80 -y
sudo apt-get install --only-upgrade linux-cloud-tools-common=4.4.0-59.80 -y
...
sudo apt-get install --only-upgrade linux-image-generic=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-source=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-crashdump=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-headers-generic=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-tools-generic=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-cloud-tools-generic=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-generic=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-headers-lowlatency=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-image-lowlatency=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-tools-lowlatency=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-cloud-tools-lowlatency=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-lowlatency=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-signed-image-generic=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-signed-generic=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-signed-image-lowlatency=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-signed-lowlatency=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-image-hwe-generic-trusty=4.4.0.59.62 -y
sudo apt-get install --only-upgrade linux-hwe-generic-trusty=4.4.0.59.62 -y
