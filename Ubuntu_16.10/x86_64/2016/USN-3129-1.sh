...
# Script generation date:     2016-11-17 21:04:33 UTC
#
...
sudo apt-get install --only-upgrade linux-image-generic=4.8.0.27.36 -y
sudo apt-get install --only-upgrade linux-image-4.8.0-27-generic=4.8.0-27.29 -y
sudo apt-get install --only-upgrade linux-image-lowlatency=4.8.0.27.36 -y
sudo apt-get install --only-upgrade linux-image-virtual=4.8.0.27.36 -y
