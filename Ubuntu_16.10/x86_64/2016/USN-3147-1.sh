...
# Script generation date:     2016-12-06 21:05:57 UTC
#
...
sudo apt-get install --only-upgrade linux-source=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-crashdump=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-headers-generic=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-tools-generic=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-cloud-tools-generic=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-generic=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-headers-lowlatency=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-image-lowlatency=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-tools-lowlatency=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-cloud-tools-lowlatency=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-lowlatency=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-signed-image-generic=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-signed-generic=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-signed-image-lowlatency=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-signed-lowlatency=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-image-hwe-generic-trusty=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-hwe-generic-trusty=4.8.0.30.39 -y
sudo apt-get install --only-upgrade linux-image-4.8.0-28-lowlatency=4.8.0-28.30 -y
sudo apt-get install --only-upgrade linux-source-4.8.0=4.8.0-30.32 -y
sudo apt-get install --only-upgrade linux-doc=4.8.0-30.32 -y
sudo apt-get install --only-upgrade linux-headers-4.8.0-28=4.8.0-28.30 -y
sudo apt-get install --only-upgrade linux-libc-dev=4.8.0-30.32 -y
sudo apt-get install --only-upgrade linux-tools-common=4.8.0-30.32 -y
sudo apt-get install --only-upgrade linux-tools-4.8.0-28=4.8.0-28.30 -y
sudo apt-get install --only-upgrade linux-cloud-tools-common=4.8.0-30.32 -y
