...
# Script generation date:     2017-01-10 21:06:15 UTC
#
...
sudo apt-get install --only-upgrade linux-signed-image-generic=4.8.0.34.43 -y
sudo apt-get install --only-upgrade linux-signed-generic=4.8.0.34.43 -y
sudo apt-get install --only-upgrade linux-signed-image-lowlatency=4.8.0.34.43 -y
sudo apt-get install --only-upgrade linux-signed-lowlatency=4.8.0.34.43 -y
